...
Latest version: 1.1.0harmattan11(Natasha)
Last update release: 2022-06-30
Arch: arm64 armv7-a
...
Classic bathroom Classic bathroom in Rivensin mod
Mod

Resurrection of EvilThe lost mission Classic DOOM RivensinHardcorps
...
Compile DOOM3-BFG:The lost mission game library named libd3le, game path name is d3le, need d3xp resources(+set fs_game_base d3xp), more view in https://www.moddb.com/mods/the-lost-mission`(now fix stack overflow when load modelmodels/mapobjects/hell/hellintro.lwoof levelgame/le_hell` map on Android).
