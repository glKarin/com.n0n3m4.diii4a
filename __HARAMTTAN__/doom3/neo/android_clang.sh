...
export TOOLCHAIN=/opt/ndk/android_cross_toolchain
...
scons \
	...
	TARGET_ANDROID=1 \
	TARGET_D3XP=0 \
	BASEFLAGS='-march=armv8-a -fno-builtin-sin -fno-builtin-cos -fno-builtin-sinf -fno-builtin-cosf -mfpu=neon -mfloat-abi=softfp -Wl,--no-undefined -fexceptions -frtti -I/data/data/com.termux/files/usr/include/android'\
	$*
