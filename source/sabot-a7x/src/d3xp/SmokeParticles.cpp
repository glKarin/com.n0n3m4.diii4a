...
================
*/
#ifdef _D3XP // cusTom3 - xp change not originally wrapped - difficult to read this way, but oh well i guess
...
#ifdef _D3XP // cusTom3 - xp change not originally wrapped - marked fix - should probably not be wrapped but...
			prevCount = floor( ((float)( deltaMsec - gameLocal.msec /*_D3XP - FIX - was USERCMD_MSEC*/ ) / finalParticleTime) * stage->totalParticles );
#else  // TODO: cusTom3 - test this with the fix and eliminate the #if 
