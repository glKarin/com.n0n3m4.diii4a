...
#ifdef _D3XP // cusTom3 - should just quit smoking anyway, bad for my health
...
#ifdef _D3XP // cusTom3 - hmmm, save games for ROE didn't need support for this, but vd3 probably still does
	for( i = 0; i < num; i++ ) {
