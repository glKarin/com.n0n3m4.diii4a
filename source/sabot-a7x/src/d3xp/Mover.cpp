...
// cusTom3 : who did this, you know it breaks everything when _D3XP isn't defined
// what advantage is there to #ifdef'ing half the code???
...
#ifdef _D3XP // cusTom3 - .time sucks, whahahha
...
#else // yes i know it is cut up to all hell ;(
...
void idMover::Event_UpdateRotation( void ) {
	...
	switch( rot.stage ) {
...
#endif // this is .slow.time consuming ;)
		...
		case FINISHED_STAGE: {
...
#ifdef _D3XP // cusTom3 - .time sucks, <cry> what am i doing </cry>
			...
			if ( g_debugMover.GetBool() ) {
#ifdef _D3XP // cusTom3 - .time sucks
