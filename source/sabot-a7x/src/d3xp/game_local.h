...
// TinMan: Ba ba black sheep
#ifdef _D3XP
#define	GAME_VERSION		"SABot a7 ROE" 
#else
#define	GAME_VERSION		"SABot a7"
#endif
...
public:
	...
	int						time;					// in msec
#ifdef _D3XP // cusTom3 - wondering if he will ever get this project to build without the defines
	...
	bool					NeedRestart();
#else // cusTom3 - these three were originally defined not virtual
