...
public final class TextHelper
{
    ...
    public static CharSequence GetCvarText()
    {
        ...
        final Cvar[] QUAKE4_CVARS = {
            Cvar.Create("harm_g_useSimpleTriggerClip", "bool", "1", "Using simple trigger clip for player/AI/vehicle touching triggers, it can optimize some solutions for doors can' open in Quake4Doom.",
