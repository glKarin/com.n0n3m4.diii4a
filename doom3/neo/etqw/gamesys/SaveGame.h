...
struct trace_t;
#else
typedef sdHandle< unsigned int, 0 > guiHandle_t; //karin: in guis/UserInterfaceTypes.h
#endif
...
#ifdef _ETQW
	void					WriteUserInterface( guiHandle_t guiHandle );
#endif
...
#ifdef _ETQW
	void					ReadUserInterface( guiHandle_t& guiHandle );
#endif
