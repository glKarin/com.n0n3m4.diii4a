...
void CPreviewDlg::BuildTree() {
	...
	if ( currentMode == GUIS ) {
		...
		AddStrList( "base", files->GetList(), MODELS );
		fileSystem->FreeFileList( files );
        files = fileSystem->ListFilesTree("models", ".md5meshs");
        AddStrList("base", files->GetList(), MODELS);
        fileSystem->FreeFileList(files);
#if _MODEL_OBJ
...
#endif
#ifdef _MODEL_PSK
        files = fileSystem->ListFilesTree("models", ".psk");
        AddStrList("base", files->GetList(), MODELS);
        fileSystem->FreeFileList(files);
#endif
#ifdef _MODEL_IQM
        files = fileSystem->ListFilesTree("models", ".iqm");
        AddStrList("base", files->GetList(), MODELS);
        fileSystem->FreeFileList(files);
#endif
#ifdef _MODEL_SMD
        files = fileSystem->ListFilesTree("models", ".smd");
        AddStrList("base", files->GetList(), MODELS);
        fileSystem->FreeFileList(files);
#endif
#ifdef _MODEL_GLTF
        files = fileSystem->ListFilesTree("models", ".gltf");
        AddStrList("base", files->GetList(), MODELS);
        fileSystem->FreeFileList(files);
        files = fileSystem->ListFilesTree("models", ".glb");
        AddStrList("base", files->GetList(), MODELS);
        fileSystem->FreeFileList(files);
#endif
#ifdef _MODEL_FBX
        files = fileSystem->ListFilesTree("models", ".fbx");
        AddStrList("base", files->GetList(), MODELS);
        fileSystem->FreeFileList(files);
#endif
