...
bool hhArcadeGame::MoveIsValid(const idVec2 &move, MovingGamePiece &piece) { //k: 1 const
...
bool hhArcadeGame::DoMove(const idVec2 &move, MovingGamePiece &piece) { //k: 1 const
