...
// Awakening BEGIN
const idEventDef EV_ControlPointController("controlPointController", "", 'f');
const idEventDef EV_ControlPercentToWin("controlPercentToWin", "", 'f');
// Awakening END
...
// Awakening BEGIN
	EVENT(EV_ControlPointController, idEntity::Event_ControlPointController)
	EVENT(EV_ControlPercentToWin,	idEntity::Event_ControlPercentToWin)
// Awakening END
END_CLASS
...
// Awakening BEGIN
void idEntity::Event_ControlPointController(void)
{
	idThread::ReturnFloat(0.0f);
}

void idEntity::Event_ControlPercentToWin(void)
{
	idThread::ReturnFloat(0.0f);
}
// Awakening END
