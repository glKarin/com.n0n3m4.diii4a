...
class WeaponGoobGun : public rvWeapon {
public:
...
private:
	...
	CLASS_STATES_PROTOTYPE ( WeaponGoobGun );
};

CLASS_DECLARATION( rvWeapon, WeaponGoobGun )
END_CLASS

/*
================
WeaponGoobGun::WeaponGoobGun
================
*/
WeaponGoobGun::WeaponGoobGun( void ) { }
...
/*
===============
WeaponGoobGun::MuzzleRise
===============
*/
void WeaponGoobGun::MuzzleRise( idVec3 &origin, idMat3 &axis ) {
	if ( wsfl.zoom )
		return;
...
/*
===============
WeaponGoobGun::UpdateCylinders
===============
*/
void WeaponGoobGun::UpdateCylinders(void)
{
	idAnimator* animator;
...
=====================
*/
void WeaponGoobGun::Save( idSaveGame *saveFile ) const 
{
	for(int i = 0; i < NAPALM_GUN_NUM_CYLINDERS; i++)
	{
...
/*
=====================
WeaponGoobGun::Restore
=====================
*/
void WeaponGoobGun::Restore( idRestoreGame *saveFile ) {
...
CLASS_STATES_DECLARATION ( WeaponGoobGun )
	STATE ( "Idle",				WeaponGoobGun::State_Idle)
	STATE ( "Fire",				WeaponGoobGun::State_Fire )
	STATE ( "Reload",			WeaponGoobGun::State_Reload )
	STATE ( "EmptyReload",		WeaponGoobGun::State_EmptyReload )
	STATE ( "MoveCylinder",		WeaponGoobGun::Frame_MoveCylinder )
	STATE ( "ResetCylinder",	WeaponGoobGun::Frame_ResetCylinder)
END_CLASS_STATES



stateResult_t WeaponGoobGun::State_Reload( const stateParms_t& parms) {
	enum {
		STAGE_INIT,
		STAGE_WAIT,
	};	
...
================
*/
stateResult_t WeaponGoobGun::State_EmptyReload( const stateParms_t& parms ) {
	enum {
		STAGE_INIT,
		STAGE_WAIT,
	};	
...
/*
================
WeaponGoobGun::State_Idle
================
*/
stateResult_t WeaponGoobGun::State_Idle( const stateParms_t& parms ) {
	enum {
		STAGE_INIT,
		STAGE_WAIT,
	};	
...
/*
================
WeaponGoobGun::State_Fire
================
*/
stateResult_t WeaponGoobGun::State_Fire( const stateParms_t& parms ) {
	enum {
		STAGE_INIT,
		STAGE_WAIT,
	};	
...
stateResult_t WeaponGoobGun::Frame_MoveCylinder( const stateParms_t& parms) {
	cylinderState = CYLINDER_MOVE_POSITION;
	return SRESULT_OK;
}

stateResult_t WeaponGoobGun::Frame_ResetCylinder( const stateParms_t& parms) {
	cylinderState = CYLINDER_RESET_POSITION;
	return SRESULT_OK;
}

void WeaponGoobGun::SpectatorCycle( void ) {
	cylinderState = CYLINDER_RESET_POSITION;
}
