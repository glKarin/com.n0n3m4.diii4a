	...
	for( int j = 0; j < height; j += 4 )
	{
		for( int i = 0; i < width; i += 4 )
		{
			...
			*/
			...
			for( int k = 0; k < 16; k++ )
			{
				block[k * 4 + 0] = Ftob( ( normals[k * 4 + 0] + 1.0f ) / 2.0f * 255.0f );
				block[k * 4 + 1] = Ftob( ( normals[k * 4 + 1] + 1.0f ) / 2.0f * 255.0f );
				block[k * 4 + 2] = Ftob( ( normals[k * 4 + 2] + 1.0f ) / 2.0f * 255.0f );
			}
#else
	...
	for( int j = 0; j < height; j += 4 )
	{
		for( int i = 0; i < width; i += 4 )
		{
			...
			for( int k = 0; k < 16; k++ )
			{
				...
				normal[1] *= rsq;
				normal[2] *= rsq;
				block[k * 4 + 0] = Ftob( ( normal[0] + 1.0f ) / 2.0f * 255.0f + 0.5f );
				block[k * 4 + 1] = Ftob( ( normal[1] + 1.0f ) / 2.0f * 255.0f + 0.5f );
				block[k * 4 + 2] = Ftob( ( normal[2] + 1.0f ) / 2.0f * 255.0f + 0.5f );
			}
