...
"    vec4 level1 = texture2D( u_fragmentMap1, megaST );\n"
"    vec4 level2 = texture2D( u_fragmentMap2, megaST * 2.0 );\n"
"    vec4 level3 = texture2D( u_fragmentMap3, megaST * 4.0 );\n"
"    vec4 level4 = texture2D( u_fragmentMap4, megaST * 8.0 );\n"
"    vec4 level5 = texture2D( u_fragmentMap5, megaST * 16.0 );\n"
