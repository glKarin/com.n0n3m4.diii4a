...
public final class Constants
{
	...
	public static final String[] CONST_CHANGES = {
            "Fixed prelight shadow's shadow mapping. And add bool cvar `harm_r_prelightStencilShadow`(default 0) for using stencil shadows if prelight shadow in shadow mapping.",
