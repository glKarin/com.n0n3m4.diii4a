...
public final class TextHelper
{
	...
	public static CharSequence GetAboutText(Context context)
	{
        ...
        final String[] ABOUTS = {
            ...
            "1. idTech4 engine:",
            " e.g. DOOM 3, DOOM 3 RoE, Quake 4, Prey(2006), The Dark Mod, DOOM 3 BFG, Skin Deep, Quadrilateral Cowboy, Icarus Starship Command Simulator and some mods(e.g. The Lost Mission, Classic DOOM).",
