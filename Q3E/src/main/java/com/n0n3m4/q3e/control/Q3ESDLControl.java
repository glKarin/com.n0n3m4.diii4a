...
public final class Q3ESDLControl extends Q3EEventControl
{
    public Q3ESDLControl(Q3EControlView controlView)
    {
        super(controlView);
    }
    ...
    {
        return SDLActivity.handleKeyEvent(controlView, keyCode, event, null, unicodeChar);
    }
