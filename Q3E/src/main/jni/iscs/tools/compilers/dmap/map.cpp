...
bool LoadDMapFile( const char *filename ) {		
	...
	if ( c_areaportals > MAX_INTER_AREA_PORTALS ) {
		common->Warning( "This map has too many visportals (also called areaportals in the source code) and so many of them will be malfunctioning. You will need to increase MAX_INTER_AREA_PORTALS in dmap.h if you want to have this many." );
	}
