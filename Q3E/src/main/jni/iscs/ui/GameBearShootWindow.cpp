...
void idGameBearShootWindow::CommonInit() {
	...
	// Precache sounds
	declManager->FindSound( "source_default_arcade_beargroan" );
	declManager->FindSound( "source_default_arcade_playershoot" );
	declManager->FindSound( "source_default_arcade_balloonpop" );
	declManager->FindSound( "source_default_arcade_levelcomplete1" );
	declManager->FindSound( "source_default_arcade_levelcomplete2" );

	// Precache dynamically used materials
	declManager->FindMaterial( "textures/materials_used_in_source/bear_shooting_game/helicopter_broken" );
	declManager->FindMaterial( "textures/materials_used_in_source/bear_shooting_game/goal_dead" );
	declManager->FindMaterial( "textures/materials_used_in_source/bear_shooting_game/gun_blast" );

	ResetGameState();

	ent = new BSEntity( this );
	turret = ent;
	ent->SetMaterial( "textures/materials_used_in_source/bear_shooting_game/turret" );
	ent->SetSize( 272, 144 );
	ent->position.x = -44;
	ent->position.y = 260;
	entities.Append( ent );
	...
	ent = new BSEntity( this );
	ent->SetMaterial( "textures/materials_used_in_source/bear_shooting_game/turret_base" );
	ent->SetSize( 144, 160 );
	ent->position.x = 16;
	ent->position.y = 280;
	entities.Append( ent );
	...
	ent = new BSEntity( this );
	bear = ent;
	ent->SetMaterial( "textures/materials_used_in_source/bear_shooting_game/bear" );
	...
	ent = new BSEntity( this );
	helicopter = ent;
	ent->SetMaterial( "textures/materials_used_in_source/bear_shooting_game/helicopter" );
	ent->SetSize( 64, 64 );
	ent->position.x = 550;
	ent->position.y = 100;
	entities.Append( ent );
	...
	ent = new BSEntity( this );
	goal = ent;
	ent->SetMaterial( "textures/materials_used_in_source/bear_shooting_game/goal" );
	ent->SetSize( 64, 64 );
	ent->position.x = 550;
	ent->position.y = 164;
	entities.Append( ent );
	...
	ent = new BSEntity( this );
	wind = ent;
	ent->SetMaterial( "textures/materials_used_in_source/bear_shooting_game/wind" );
	ent->SetSize( 100, 40 );
	ent->position.x = 500;
	ent->position.y = 430;
	entities.Append( ent );
	...
	ent = new BSEntity( this );
	gunblast = ent;
	ent->SetMaterial( "textures/materials_used_in_source/bear_shooting_game/gun_blast" );
	ent->SetSize( 64, 64 );
	ent->SetVisible( false );
	entities.Append( ent );
}
...
void idGameBearShootWindow::UpdateBear() {
	...
	if ( !bearHitTarget && !gameOver ) {
		...
		if ( collision ) {
			...
			helicopter->SetMaterial( "textures/materials_used_in_source/bear_shooting_game/helicopter_broken" );
			helicopter->velocity.y = 230.f;
			goal->velocity.y = 230.f;
			session->sw->PlayShaderDirectly( "source_default_arcade_balloonpop" );
	...
	if ( bearIsShrinking ) {
		...
		if ( bearScale < 0 ) {
			...
			if ( bearHitTarget ) {
				goal->SetMaterial( "textures/materials_used_in_source/bear_shooting_game/goal" );
				goal->position.x = 550;
				goal->position.y = 164;
				goal->velocity.Zero();
				...
				helicopter->SetMaterial( "textures/materials_used_in_source/bear_shooting_game/helicopter" );
...
void idGameBearShootWindow::UpdateHelicopter() {
	...
	if ( bearHitTarget && bearIsShrinking ) {
		if ( helicopter->velocity.y != 0 && helicopter->position.y > 264 ) {
			...
			goal->SetMaterial( "textures/materials_used_in_source/bear_shooting_game/goal_dead" );
			session->sw->PlayShaderDirectly( "source_default_arcade_beargroan", 1 );
...
void idGameBearShootWindow::UpdateButtons() {
	...
	if ( onFire ) {
		...
		session->sw->PlayShaderDirectly( "source_default_arcade_playershoot" );
...
void idGameBearShootWindow::UpdateScore() {
	...
	if ( !(goalsHit % 5) ) {
		...
		if ( currentLevel <= 1 ) {
			session->sw->PlayShaderDirectly( "source_default_arcade_levelcomplete1", 3 );
		} else {
			session->sw->PlayShaderDirectly( "source_default_arcade_levelcomplete2", 3 );
		}
