...
// contents flags, NOTE: make sure to keep the defines in icarus_defs.script up to date with these!
typedef enum {
...
public:
	...
	void				SetParm11ExpressionRegister( float value_to_set ) const;
	mutable bool				override_parm11;
	mutable float				override_parm11_value;
