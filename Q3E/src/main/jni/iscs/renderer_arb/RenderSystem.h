...
const int SMALLCHAR_WIDTH		= 16;
const int SMALLCHAR_HEIGHT		= 32;
const int BIGCHAR_WIDTH			= 32;
const int BIGCHAR_HEIGHT		= 32;

// all drawing is done to a 1280 x 960 virtual screen size
...
public:
	...
	virtual void			DrawStretchPic( const idDrawVert *verts, const glIndex_t *indexes, int vertCount, int indexCount, const idMaterial *material,
											bool clip = true, float min_x = 0.0f, float min_y = 0.0f, float max_x = 1280.0f, float max_y = 960.0f ) = 0;
