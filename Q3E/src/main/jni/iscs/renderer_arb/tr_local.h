...
// BOYETTE SPACE COMMAND NOTE: this was originally const idMaterial *R_RemapShaderBySkin( const idMaterial *shader, const idDeclSkin *customSkin, const idMaterial *customShader) - we added the last parameter for the hide weapons skin functionality
const idMaterial *R_RemapShaderBySkin( const idMaterial *shader, const idDeclSkin *customSkin, const idMaterial *customShader, const idDeclSkin *originalCustomSkin );
...
public:
	...
	virtual void			DrawStretchPic ( const idDrawVert *verts, const glIndex_t *indexes, int vertCount, int indexCount, const idMaterial *material,
											bool clip = true, float x = 0.0f, float y = 0.0f, float w = 1280.0f, float h = 0.0f );
	...
	// BOYETTE BEGIN:
	virtual bool			CheckIfResolutionModeIsSupported( int r_mode_num );
	// BOYETTE END
...
extern idCVar r_mode_experimental;		// video mode experimental
...
extern idCVar r_useExpensiveShadowOptimizations;	// 1 = use (in real time) the expensive shadows normally reserved for the dmap generated shadows
...
// BOYETTE BEGIN
bool CheckIfScreenResolutionIsSupported( int width_to_check, int height_to_check );
// BOYETTE END

bool		GLimp_Init( glimpParms_t parms );
// If the desired mode can't be set satisfactorily, false will be returned.
// The renderer will then reset the glimpParms to "safe mode" of 1280x960
