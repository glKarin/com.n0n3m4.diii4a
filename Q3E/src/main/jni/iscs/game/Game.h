...
// default scripts
#define SCRIPT_DEFAULTDEFS			"script/icarus_defs.script"
#define SCRIPT_DEFAULT				"script/icarus_main.script"
#define SCRIPT_DEFAULTFUNC			"icarus_main"
...
public:
	...
	virtual idUserInterface *	PlayerGUIOverlay() = 0;
	virtual bool				HandleGuiCommandsOnPlayer( const char *cmds ) = 0;
