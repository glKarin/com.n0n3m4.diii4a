...
// boyette mod begin
class idTarget_DisplayGui : public idTarget {
public:
	CLASS_PROTOTYPE(idTarget_DisplayGui);

protected:
	void		Event_Activate( idEntity *activator );
};

class idTarget_DisplayCaptainGui : public idTarget {
public:
	CLASS_PROTOTYPE(idTarget_DisplayCaptainGui);
