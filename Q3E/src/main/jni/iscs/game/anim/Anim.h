...
//
// animation channels.  make sure to change script/icarus_defs.script if you add any channels, or change their order
//
...
//
// joint modifier modes.  make sure to change script/icarus_defs.script if you add any, or change their order.
//
typedef enum {
