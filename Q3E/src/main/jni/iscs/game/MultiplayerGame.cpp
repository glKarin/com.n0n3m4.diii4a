...
const char *idMultiplayerGame::GlobalSoundStrings[] = {
	"sound/sounds_used_in_source/feedback/voc_youwin.wav",
	"sound/sounds_used_in_source/feedback/voc_youlose.wav",
	"sound/sounds_used_in_source/feedback/fight.wav",
	"sound/sounds_used_in_source/feedback/vote_now.wav",
	"sound/sounds_used_in_source/feedback/vote_passed.wav",
	"sound/sounds_used_in_source/feedback/vote_failed.wav",
	"sound/sounds_used_in_source/feedback/three.wav",
	"sound/sounds_used_in_source/feedback/two.wav",
	"sound/sounds_used_in_source/feedback/one.wav",
	"sound/sounds_used_in_source/feedback/sudden_death.wav",
#ifdef CTF
	"sound/sounds_used_in_source/ctf/flag_capped_yours.wav",
	"sound/sounds_used_in_source/ctf/flag_capped_theirs.wav",
	"sound/sounds_used_in_source/ctf/flag_return.wav",
	"sound/sounds_used_in_source/ctf/flag_taken_yours.wav",
	"sound/sounds_used_in_source/ctf/flag_taken_theirs.wav",
	"sound/sounds_used_in_source/ctf/flag_dropped_yours.wav",
	"sound/sounds_used_in_source/ctf/flag_dropped_theirs.wav"
#endif
};
...
void idMultiplayerGame::Precache( void ) {
	...
	gameLocal.FindEntityDefDict( "player_icarus_officer", false );;
...
void idMultiplayerGame::VoiceChat( const idCmdArgs &args, bool team ) {
	...
	voc = args.Argv( 1 );
	spawnArgs = gameLocal.FindEntityDefDict( "player_icarus_officer", false );
