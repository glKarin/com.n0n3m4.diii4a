...
"\n",
"#ifdef USEBLOOM\n",
"	dp_FragColor += max(vec4(0.0,0.0,0.0,0.0), dp_texture2D(Texture_Second, TexCoord2) - BloomColorSubtract);\n",
"#endif\n",
"\n",
"#ifdef USEVIEWTINT\n",
...
"#endif\n",
"#ifdef USEGAMMARAMPS\n",
"	dp_FragColor.r = dp_texture2D(Texture_GammaRamps, vec2(dp_FragColor.r, 0.0)).r;\n",
"	dp_FragColor.g = dp_texture2D(Texture_GammaRamps, vec2(dp_FragColor.g, 0.0)).g;\n",
"	dp_FragColor.b = dp_texture2D(Texture_GammaRamps, vec2(dp_FragColor.b, 0.0)).b;\n",
"#endif\n",
"#ifdef USEALPHAKILL\n",
