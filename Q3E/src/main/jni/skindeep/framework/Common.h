...
extern idCVar		com_showHitchWarnings;

// blendo eric: use doubles for timing
extern idCVar		com_timing;
extern double		time_gameGUI;			// game gui and other pregame time
extern double		time_gameFrame;			// game logic time
extern double		time_gameDraw;			// game present time
extern double		time_frontend;			// renderer frontend time
extern double		time_backend;			// renderer backend time
extern double		time_alpha;				// frontend time
extern double		time_beta;				// renderer backend time
...
public:
	...
	virtual void				Frame( void ) = 0;
								...
								// Returns frame time (number of tics * frame length)
	virtual int					FrameTime(void) = 0;
