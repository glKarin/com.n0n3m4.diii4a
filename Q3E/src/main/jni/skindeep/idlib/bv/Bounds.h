...
public:
	...
	idVec3			Max(void) const;
	idVec3			Min(void) const;
...
ID_INLINE float idBounds::zMax(void) const
{
	return (b[0].z > b[1].z) ? b[0].z : b[1].z;
}

ID_INLINE float idBounds::zMin(void) const
{
	return (b[0].z < b[1].z) ? b[0].z : b[1].z;
}

ID_INLINE idVec3 idBounds::Max(void) const
{
	return idVec3(b[1]);
}

ID_INLINE idVec3 idBounds::Min(void) const
{
	return idVec3(b[0]);
}
