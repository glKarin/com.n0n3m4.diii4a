...
typedef struct cm_traceWork_s {
	...
	int ignoreContents;								// SM: Inverse of the above -- ignore anything that DOES have any of these content flags
...
private:			// CollisionMap_rotate.cpp
	...
	void			Rotation180( trace_t *results, const idVec3 &rorg, const idVec3 &axis,
									...
									const idTraceModel *trm, const idMat3 &trmAxis, int contentMask,
									cmHandle_t model, const idVec3 &origin, const idMat3 &modelAxis, int ignoreContentMask );
