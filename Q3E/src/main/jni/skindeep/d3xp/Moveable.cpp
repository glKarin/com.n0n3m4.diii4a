...
void idMoveable::Spawn( void ) {
	...
	float linearFriction = spawnArgs.GetFloat("linear_friction", "0.6");
	float angularFriction = spawnArgs.GetFloat("angular_friction", "0.6");
	...
	//physicsObj.SetGravity(idVec3(0, 0, spawnArgs.GetInt("gravity", "-30"))); //BC
...
================
*/
void idExplodingBarrel::Damage( idEntity *inflictor, idEntity *attacker, const idVec3 &dir, const char *damageDefName, const float damageScale, const int location, const int materialType ) {
