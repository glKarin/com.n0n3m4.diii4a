...
// blendo eric: increase script size, mainly for text
#define BLENDO_BIG_SCRIPTS
#ifdef BLENDO_BIG_SCRIPTS 

#define MAX_STRING_LEN		1024
#define MAX_GLOBALS			1048576			// in bytes
#define MAX_STRINGS			1024
#define MAX_FUNCS			3584
#define MAX_STATEMENTS		131072			// statement_t - 18 bytes last I checked

#else //!BLENDO_BIG_SCRIPTS
