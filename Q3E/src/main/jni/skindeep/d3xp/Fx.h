...
public:
	...
	// SM: Added version that doesn't take entity and requires origin/axis
	static idEntityFx *		StartFx( const char *fx, const idVec3 &useOrigin, const idMat3 &useAxis, idEntity *ent = NULL, bool bind = false );
...
private:
	...
	//BC
	void					ForceFade(const idFXSingleAction& fxaction, idFXLocalAction& laction, int time);
	int						forcefadeStartTime;
};
