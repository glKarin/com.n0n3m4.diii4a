...
extern idCVar	ai_showState;
extern idCVar	ai_showAnimState;
extern idCVar	ai_showPlayerState;
extern idCVar	ai_showInterestPoints;
extern idCVar	ai_targetPredictTime;
...
extern idCVar	pm_staminachargedelay;
...
extern idCVar	pm_airlessCrouch;
...
extern idCVar	aas_showSingleArea; //bc
...
//BC
extern idCVar	g_showmaterial;
extern idCVar	g_showmodel;
extern idCVar	ai_debugPerception;
extern idCVar	g_showPlayerBody;
extern idCVar	g_showEntityHealth;
extern idCVar	g_screenshake;
extern idCVar	g_headbob;
extern idCVar	g_menupause;
extern idCVar	g_hiteffects;
extern idCVar	g_clambermaxheight;
extern idCVar	g_savingthrows;
extern idCVar	g_cryospawn;
extern idCVar	g_showEntityNumber;
extern idCVar	g_showEntityDetail;
extern idCVar	g_ruler;
extern idCVar	ai_debugRepairbot;
extern idCVar	g_showParticleFX;
extern idCVar	g_repairenabled;
extern idCVar	g_searchtime;
extern idCVar	r_skipspaceparticles;
extern idCVar	g_oxygenscale;
extern idCVar	g_spawnfilter;
extern idCVar	g_spawnfilter_usemapsetting;
extern idCVar	g_hideHudInternal;
extern idCVar	g_useBlendoImageCache;
extern idCVar	g_inspectDebug;
extern idCVar	pm_spacespeed;
extern idCVar	rb_angularDampen;
extern idCVar	g_showPlayerSpeed;
extern idCVar	g_carryDebug;
extern idCVar	g_perceptionScale;
extern idCVar	g_safescreen;
extern idCVar	g_debugEmailScript;
extern idCVar	g_zoominspectDebug;
extern idCVar	g_showModelNames;
extern idCVar	g_zoominspectShowCameraPosition;

// SW
extern idCVar g_luminance_enabled;
extern idCVar g_luminance_occlusionTestType;
extern idCVar g_luminance_updateRate;
extern idCVar g_luminance_greyscaleConversion;
extern idCVar g_meta_candidateDistanceMetric;
extern idCVar g_luminance_showvalue;

extern idCVar g_eventLog_logToFile;

extern idCVar g_skyOverride;

extern idCVar g_teleFocusError;
extern idCVar g_teleFocusTime;
extern idCVar g_teleSeenTime;
extern idCVar g_autorunVignettes;

extern idCVar g_showInterestPoints;
...
extern idCVar g_blur_numIterations;
extern idCVar g_blur_intensity;
extern idCVar g_motionBlur_testEnable;
extern idCVar g_motionBlur_intensity;

extern idCVar in_toggleCrouch;
extern idCVar m_leanSensitivity;

//eric
extern idCVar g_showClipBodies;
extern idCVar g_showAimAssistTrace;

extern idCVar gui_subtitleCutoffIntensity;
extern idCVar gui_inGameLeftClick;

extern idCVar pm_clamberEdgeDetection;
extern idCVar pm_clamberReachDist;
extern idCVar pm_clamberCubbyExitDistFront;
extern idCVar pm_clamberCubbyExitDistBack;

extern idCVar gamepad_rumble_intensity;
extern idCVar gamepad_light_intensity;
extern idCVar gamepad_screenshake_rumble;
extern idCVar gamepad_screenshake_light;
extern idCVar gamepad_fx_background;
extern idCVar gamepad_fx_debug;
extern idCVar gamepad_rumble_enable;
