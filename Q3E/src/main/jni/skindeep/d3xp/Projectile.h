...
public :
	...
	//BC PUBLIC
	bool					neutralized; //For point-defense disabled bullets
...
private:
	...
	//BC PRIVATE
	idEntity	*			DoEntDamage(idEntity	*ent, float damageScale, const trace_t &collision, const char	*damageDefName, idVec3 dir);
	int						displayDelaytime;
	idEntityPtr<idEntity>	originalOwner;
