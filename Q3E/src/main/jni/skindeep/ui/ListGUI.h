...
public:
	...
	virtual void		Save( idSaveGame *savefile ) const = 0; // blendo eric
	virtual void		Restore( idRestoreGame *savefile ) = 0; // blendo eric

	virtual void		Config( idUserInterface *pGUI, const char *name ) = 0;
	virtual void		Add( int id, const idStr& s, bool allowDupes = false ) = 0;
