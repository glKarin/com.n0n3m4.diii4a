...
private:
	...
	float				timeSlice;
	//float				timeRemaining; //BC no more time limit.
	bool				gameOver;
	...
	BSEntity			*turret; //the turret (player)
	BSEntity			*bear;	//the banana (bullet)
	BSEntity			*helicopter; //the enemy primate
	BSEntity			*goal;		//the powerup
	//BSEntity			*wind;
	BSEntity			*gunblast;	//the bomb
