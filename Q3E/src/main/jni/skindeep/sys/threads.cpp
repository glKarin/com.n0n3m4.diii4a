...
/* blendo eric: for sec timing of perfcounter
================
Sys_GetPerformanceCounter
================
*/
...
================
Sys_GetPerformanceCounterMS
================
*/
double Sys_GetPerformanceTimeMS(uint64 count) {
	return count*1000.0/SDL_GetPerformanceFrequency();
}
