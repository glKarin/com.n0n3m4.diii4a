...
typedef enum {
	SO_NONE,			// 0 // BOYETTE NOTE: I haven't tried this one yet - should test this one.
	SO_MERGE_SURFACES,	// 1 // BOYETTE NOTE: this one causes some artifacts.
	SO_CULL_OCCLUDED,	// 2 // BOYETTE NOTE: this one works the best - takes a bit longer - but it has alot of unnecessary print statements that could probably be removed.
	SO_CLIP_OCCLUDERS,	// 3 // BOYETTE NOTE: I haven't tried this one yet - should test this one.
	SO_CLIP_SILS,		// 4 // BOYETTE NOTE: I haven't tried this one yet - should test this one.
	SO_SIL_OPTIMIZE		// 5 // BOYETTE NOTE: this one doesn't seem to work well at all - and takes an extrememly long amount of time - was probably an expirimental version.
} shadowOptLevel_t;
...
#define	MAX_INTER_AREA_PORTALS	8192 // BOYETTE NOTE: was originally 1024 - if the number of visportals on a map goes above this number - there will be a significant amount of malfunctioning visportals
