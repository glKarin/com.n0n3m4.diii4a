...
//	dmapGlobals.shadowOptLevel = SO_MERGE_SURFACES;		// create shadows by merging all surfaces, but no super optimization // BOYETTE NOTE: this was the original default setting
...
//	dmapGlobals.shadowOptLevel = SO_SIL_OPTIMIZE;
	dmapGlobals.shadowOptLevel = SO_CULL_OCCLUDED; // BOYETTE NOTE: this was what we changed it to.
