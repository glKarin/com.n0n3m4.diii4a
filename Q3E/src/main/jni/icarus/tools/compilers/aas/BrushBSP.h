...
public:
	...
	// BOYETTE HOPEFULLY RUNAAS ERROR FIX BEGIN
	idBrushBSPNode *		parent;			// parent of this node // BOYETTE NOTE: This used to be private - but when a node is removed these need to be set to NULL - so I made them public
	idBrushBSPNode *		children[2];	// both are NULL if this is a leaf node // BOYETTE NOTE: This used to be private - but when a node is removed these need to be set to NULL - so I made them public
	// BOYETTE HOPEFULLY RUNAAS ERROR FIX END
