...
void MaterialEditorInit( void ) {
	...
	// hide the icarus window by default
...
/**
* Called every frame by the id tech 4 engine to allow the material editor to process messages.
*/
...
/**
* Called by the id tech 4 engine when the material editor needs to be destroyed.
*/
...
/**
* Allows the id tech 4 engine to reflect console output to the material editors console.
*/
