...
void idGLDrawableView::ResetView( void ) {
	...
	worldModel = renderModelManager->FindModel("models/materialeditor/placeholder_sphere_64.ase"); // was originally "models/materialeditor/cube128.ase"
...
void idGLDrawableView::UpdateModel( void ) {
	...
	switch( objectId ) {
		case 0:
			...
			break;
		case 1:
			worldModel = renderModelManager->FindModel("models/materialeditor/placeholder_sphere_64.ase"); // was originally "models/materialeditor/box128x64.ase"
			break;
		case 2:
			worldModel = renderModelManager->FindModel("models/materialeditor/placeholder_sphere_64.ase"); // was originally "models/materialeditor/box128x32.ase"
			break;
		case 3:
			worldModel = renderModelManager->FindModel("models/materialeditor/placeholder_sphere_64.ase"); // was originally "models/materialeditor/box64x128.ase"
			break;
		case 4:
			worldModel = renderModelManager->FindModel("models/materialeditor/placeholder_sphere_64.ase"); // was originally "models/materialeditor/box32x128.ase"
			break;
		case 5:
			worldModel = renderModelManager->FindModel("models/materialeditor/placeholder_sphere_64.ase"); // was originally "models/materialeditor/cylinder_v.ase"
			break;
		case 6:
			worldModel = renderModelManager->FindModel("models/materialeditor/placeholder_sphere_64.ase"); // was originally "models/materialeditor/cylinder_h.ase"
			break;
		case 7:
			worldModel = renderModelManager->FindModel("models/materialeditor/placeholder_sphere_64.ase"); // was originally "models/materialeditor/sphere64.ase"
			break;
		case -1:
