...
loopMemToL1: 
        prefetchnta 64[ESI] // Prefetch next loop, non-temporal
        //prefetchnta 96[ESI] // BOYETTE NOTE: commented out because dr. memory said it was a problem - and it doesn't seem necessary - it may have a performance impact but it is safe to comment out
