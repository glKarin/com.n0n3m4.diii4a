...
public:
	...
	virtual void			OpenFullScreenGUIOverlay( void ) {};
	virtual void			CloseFullScreenGUIOverlay( void ) {};
	virtual void			SyncUpGuiActiveOnMapLoad( void ) {};
	...
	virtual bool			ShiftKeyIsDown() { return false; };
	...
	//virtual CStatsAndAchievements *m_pStatsAndAchievements;
	//virtual CSteamLocalInventory *SteamLocalInventory();

	virtual void			StoreSteamStats( void ) {};
...
xthreadInfo *	g_threads[ORIGINAL_MAX_THREADS];
int				g_thread_count;
