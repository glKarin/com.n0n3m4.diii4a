...
public:
	...
	bool					CanSeeAllEntityBounds( idEntity* ent );
	bool					CanSeeAnyEntityBounds( idEntity* ent );
...
private:
	...
	bool					flipAxis;
	float					scanDist;
	//float					scanFov; // BOYETTE SPACE COMMAND NOTE: moved up to public - shouldn't cause any problems.
