...
public:
	...
	void					EnableGrabber( bool active )			{ grabberEnabled = active; startWarpTime = gameLocal.time; };
...
/*
==================
FullscreenFX_Desaturate
==================
*/
class FullscreenFX_Desaturate : public FullscreenFX {
	const idMaterial*		material;
