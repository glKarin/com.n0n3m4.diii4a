...
typedef int ammo_t;
static const int AMMO_NUMTYPES = 32; // boyette bit - this was orginally 16 - trying to change to 32 - not sure if this will work.
...
public:
	...
	void					Event_OwnerBeginsUsingSpaceCommandTablet( void );
	void					Event_OwnerStopsUsingSpaceCommandTablet( void );
	void					Event_OwnerActivatesSpaceCommandTabletBeam( void );
	void					Event_OwnerDeactivatesSpaceCommandTabletBeam( void );
	void					Event_OwnerSpaceCommandTabletBeamIsActive( void );
	void					Event_GiveAmmo( int amount );
