...
#if defined( _WIN32 ) && !defined( ID_DEDICATED ) && !defined( ID_DEMO_BUILD ) && defined( ID_ENABLE_MFC )
...
#ifndef ID_OPENAL
#	if ( defined(_WIN32) || defined(MACOS_X) || defined(_DIII4A) ) && !defined( ID_DEDICATED ) //karin: use OpenAL
#		define ID_OPENAL 1
#	else
#		define ID_OPENAL 0
#	endif
