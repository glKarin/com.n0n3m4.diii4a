...
#ifdef _DIII4A //karin: allow console default
...
#ifdef _DIII4A //karin: force setup resolution on Android
    Sys_ForceResolution();
#endif
...
#ifdef _DIII4A //karin: check OpenGL version from command cvar
