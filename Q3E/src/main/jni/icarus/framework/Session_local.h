...
public:
	...
	virtual void		SetGUIActive( idUserInterface *gui );
	...
	bool				restartingCurrentMap;	// currently restarting the current map - only used for the screen wipe right now
...
// BOYETTE BEGIN
	void				ReloadMaterialImages( const char *material_name );
// BOYETTE END
