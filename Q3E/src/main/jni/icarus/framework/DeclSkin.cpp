...
===============
*/
const idMaterial *idDeclSkin::RemapShaderBySkins( const idMaterial *shader, const idDeclSkin *other_skin ) const {
	int		i;
	...
	for ( i = 0; i < other_skin->mappings.Num() ; i++ ) {
		const skinMapping_t	*map = &other_skin->mappings[i];
