...
// boyette begin
const int IMPULSE_41			= 41;			// bring up captain display
const int IMPULSE_42			= 42;			// toggle showing the map on the hud
// boyette end
