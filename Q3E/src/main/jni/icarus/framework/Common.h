...
public:
	...
	idParallelJobList *		gameLogicJobList;
	virtual void			AddJobToGameLogicJobList( jobRun_t function, void * data ) = 0;
	virtual void			SubmitGameLogicJobList( void ) = 0;
	virtual void			WaitGameLogicJobList( void ) = 0;
	...
	virtual void			OpenFullScreenGUIOverlay( void ) = 0;
	virtual void			CloseFullScreenGUIOverlay( void ) = 0;
	virtual void			SyncUpGuiActiveOnMapLoad( void ) = 0;
...
#ifdef STEAM_BUILD
	//virtual CStatsAndAchievements*			GetSteamStatsAndAchievements( void ) = 0;
	//virtual CSteamLocalInventory*			GetSteamInventory( void ) = 0;

	CStatsAndAchievements *m_pStatsAndAchievements;
	CSteamLocalInventory *SteamLocalInventory();

	virtual void			StoreSteamStats( void ) = 0;
#endif
