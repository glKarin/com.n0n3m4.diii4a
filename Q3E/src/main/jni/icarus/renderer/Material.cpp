...
void idMaterial::CommonInit()
{
	...
	override_parm11 = false;
	override_parm11_value = 1.0f;
#endif
}
...
#ifdef _ICARUS //karin: renderer compat
	if ( override_parm11 )
		registers[EXP_REG_PARM11] = override_parm11_value;
	else
#endif
...
/*
===================
idMaterial::SetParm11ExpressionRegister
===================
*/
void idMaterial::SetParm11ExpressionRegister( float value_to_set ) const {
	override_parm11 = true;
	override_parm11_value = value_to_set;
}
#endif
