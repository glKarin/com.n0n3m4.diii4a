...
void R_RenderGuiSurf(idUserInterface *gui, drawSurf_t *drawSurf)
{
	...
	guiModelMatrix[0] = axis[0][0] / 1280.0;
	guiModelMatrix[4] = axis[1][0] / 960.0;
#else
...
#ifdef _ICARUS //karin: 1280x960
	guiModelMatrix[1] = axis[0][1] / 1280.0;
	guiModelMatrix[5] = axis[1][1] / 960.0;
#else
...
#ifdef _ICARUS //karin: 1280x960
	guiModelMatrix[2] = axis[0][2] / 1280.0;
	guiModelMatrix[6] = axis[1][2] / 960.0;
#else
