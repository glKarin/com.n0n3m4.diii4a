...
static void glrbTransformPoint(const GLfloat mvp[16], int screenWidth, int screenHeight, const GLfloat pos[3], GLfloat ret[2]) {
...
static void glrbTransformPoint(const GLfloat pos[3], GLfloat ret[2]) {
    ...
    glrbTransformPoint(mvp, viewport[2], viewport[3], pos, ret);
}

static GLfloat glrbGetPixelsScaler(void)
{
    idVec2 v1;
    idVec2 v2;
    glrbTransformPoint(idVec3(0.0f, 0.0f, 0.0f).ToFloatPtr(), v1.ToFloatPtr());
    glrbTransformPoint(idVec3(1.0f, 0.0f, 0.0f).ToFloatPtr(), v2.ToFloatPtr());
    idVec2 v3 = v2 - v1;
    return v3.Length();
}
...
GLRB_API void glColor4ubv(const GLubyte v[4])
{
...
GLRB_API void glVertexPointer(GLint size, GLenum type, GLsizei stride, const GLvoid *pointer)
{
...
GLRB_API void glRasterPos3fv(const GLfloat p[3])
{
...
GLRB_API void glCallLists( GLsizei n, GLenum type, const GLvoid *lists )
{
    ...
    //GLfloat scaler = 1.0f / glrbGetPixelsScaler();
...
/*                idVec2 c1, c2;
                glrbTransformPoint(mvp, screenWidth, screenHeight, p1.ToFloatPtr(), c1.ToFloatPtr());
                glrbTransformPoint(mvp, screenWidth, screenHeight, p2.ToFloatPtr(), c2.ToFloatPtr());
...
GLRB_API void glesReadPixels(GLint x, GLint y, GLsizei width, GLsizei height, GLenum format, GLenum type, void * data, GLsizei align)
{
