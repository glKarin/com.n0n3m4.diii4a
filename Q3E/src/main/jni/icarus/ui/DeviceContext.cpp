...
idVec4 idDeviceContext::colorMultiSelectBox;
...
// BOYETTE BEGIN:
	...
	// to ensure proper saving and loading of fontNum on idWindow
	FindFont( "fonts/Inconsolata" );
	FindFont( "fonts/Inconsolata_Bold" );
	FindFont( "fonts/Inconsolata_Regular" );
	FindFont( "fonts/Jolly_Lodger" );
	FindFont( "fonts/orbitron_black" );
	FindFont( "fonts/Orbitron_Bold" );
	FindFont( "fonts/Orbitron_Medium" );
	FindFont( "fonts/Orbitron_Regular" );

	/*
	FindFont( "fonts/Ubuntu_Mono_Bold" );
	FindFont( "fonts/Ubuntu_Mono_BoldItalic" );
	FindFont( "fonts/Ubuntu_Mono_Italic" );
	FindFont( "fonts/Ubuntu_Mono_Regular" );
	FindFont( "fonts/Walter_Turncoat" );
	FindFont( "fonts/Zeyada" );
	FindFont( "fonts/Antic_Didone" );
	FindFont( "fonts/Arapey_Italic" );
	FindFont( "fonts/Arapey_Regular" );
	FindFont( "fonts/Arial_Black" );
	FindFont( "fonts/Arial_Bold" );
	FindFont( "fonts/Arial_Regular" );
	FindFont( "fonts/Averia_Libre_Bold" );
	FindFont( "fonts/Averia_Libre_BoldItalic" );
	FindFont( "fonts/Averia_Libre_Italic" );
	FindFont( "fonts/Averia_Libre_Light" );
	FindFont( "fonts/Averia_Libre_LightItalic" );
	FindFont( "fonts/Averia_Libre_Regular" );
	FindFont( "fonts/Bad_Script" );
	FindFont( "fonts/Bilbo" );
	FindFont( "fonts/Bitter_Bold" );
	FindFont( "fonts/Bitter_Regular.ttf" );
	FindFont( "fonts/Bitter-Italic" );
	FindFont( "fonts/Bree_Serif" );
	FindFont( "fonts/Calligraffitti" );
	FindFont( "fonts/Cantata_One" );
	FindFont( "fonts/Codystar_Light" );
	FindFont( "fonts/Codystar_Regular" );
	FindFont( "fonts/Comfortaa_Bold" );
	FindFont( "fonts/Comfortaa_Light" );
	FindFont( "fonts/Comfortaa_Regular" );
	FindFont( "fonts/Condiment" );
	FindFont( "fonts/Crafty_Girls" );
	FindFont( "fonts/Droid_Sans_Bold" );
	FindFont( "fonts/Droid_Sans_Mono" );
	FindFont( "fonts/Droid_Sans_Regular" );
	FindFont( "fonts/Dynalight" );
	FindFont( "fonts/Emilys_Candy" );
	FindFont( "fonts/Fascinate_Inline" );
	FindFont( "fonts/Fondamento_Italic" );
	FindFont( "fonts/Fondamento_Regular" );
	FindFont( "fonts/Glass_Antiqua" );
	FindFont( "fonts/Gloria_Hallelujah" );
	FindFont( "fonts/Gorditas_Bold" );
	FindFont( "fonts/Gorditas_Regular" );
	FindFont( "fonts/Handlee" );
	FindFont( "fonts/Henny_Penny" );
	FindFont( "fonts/Imprima" );
	FindFont( "fonts/Inconsolata" );
	FindFont( "fonts/Inconsolata_Bold" );
	FindFont( "fonts/Inconsolata_Regular" );
	FindFont( "fonts/Indie_Flower" );
	FindFont( "fonts/Italiana" );
	FindFont( "fonts/Italianno" );
	FindFont( "fonts/Jim_Nightshade" );
	FindFont( "fonts/Jolly_Lodger" );
	FindFont( "fonts/Judson_Bold" );
	FindFont( "fonts/Judson_Italic" );
	FindFont( "fonts/Judson_Regular" );
	FindFont( "fonts/Kristi" );
	FindFont( "fonts/La_Belle_Aurore" );
	FindFont( "fonts/Lobster" );
	FindFont( "fonts/Londrina_Outline_Regular" );
	FindFont( "fonts/Londrina_Sketch" );
	FindFont( "fonts/Loved_by_the_King" );
	FindFont( "fonts/Lovers_Quarrel" );
	FindFont( "fonts/Lustria" );
	FindFont( "fonts/Monofett" );
	FindFont( "fonts/Monoton" );
	FindFont( "fonts/Nobile_Bold" );
	FindFont( "fonts/Nobile_Bold_Italic" );
	FindFont( "fonts/Nobile_Italic" );
	FindFont( "fonts/Nobile_Regular" );
	FindFont( "fonts/Nova_Square" );
	FindFont( "fonts/NovaMono" );
	FindFont( "fonts/Nunito_Bold" );
	FindFont( "fonts/Nunito_Light" );
	FindFont( "fonts/Nunito_Regular" );
	FindFont( "fonts/Oleo_Script_Bold" );
	FindFont( "fonts/Oleo_Script_Regular" );
	FindFont( "fonts/Open_Sans_Bold" );
	FindFont( "fonts/Open_Sans_BoldItalic" );
	FindFont( "fonts/Open_Sans_Italic" );
	FindFont( "fonts/Open_Sans_Light_Italic" );
	FindFont( "fonts/Open_Sans_Regular" );
	FindFont( "fonts/Open_Sans_Semibold_MIGHT-NOT-WORK" );
	FindFont( "fonts/orbitron_black" );
	FindFont( "fonts/Orbitron_Bold" );
	FindFont( "fonts/Orbitron_Medium" );
	FindFont( "fonts/Orbitron_Regular" );
	FindFont( "fonts/Oswald-Bold" );
	FindFont( "fonts/Oswald-Light" );
	FindFont( "fonts/Oswald-Regular" );
	FindFont( "fonts/Over_the_Rainbow" );
	FindFont( "fonts/Oxygen" );
	FindFont( "fonts/Permanent_Marker" );
	FindFont( "fonts/Princess_Sofia" );
	FindFont( "fonts/PT_Mono" );
	FindFont( "fonts/Ribeye_Marrow" );
	FindFont( "fonts/Rock_Salt" );
	FindFont( "fonts/Russo_One" );
	FindFont( "fonts/Schoolbell" );
	FindFont( "fonts/SirinStencil" );
	FindFont( "fonts/Sunshiney" );
	FindFont( "fonts/Tienne_Bold" );
	FindFont( "fonts/Tienne_Heavy" );
	FindFont( "fonts/Tienne_Regular" );
	*/
// BOYETTE END
}
...
void idDeviceContext::Init() {
	...
	whiteImage = declManager->FindMaterial("textures/images_used_in_source/white.tga");
...
// boyette space command begin
	colorMultiSelectBox = idVec4(0.0f, 0.65f, 0.77f, 1.0f);
// boyette space command end
	...
	cursorImages[CURSOR_TARGETING] = declManager->FindMaterial("ui/assets/guicursor_arrowtargetingreticule.tga");
	cursorImages[CURSOR_MISSILE] = declManager->FindMaterial("ui/assets/guicursor_missiletargetingreticule.tga");
	...
	cursorImages[CURSOR_TARGETING]->SetSort( SS_GUI );
	cursorImages[CURSOR_MISSILE]->SetSort( SS_GUI );
...
int idDeviceContext::GetCursorNum() {
	return cursor;
}
