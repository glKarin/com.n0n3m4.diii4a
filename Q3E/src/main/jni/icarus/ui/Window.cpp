...
intptr_t idWindow::GetWinVarOffset( idWinVar *wv, drawWin_t* owner) {
	...
	if ( wv == &background_parm11 ) {
		ret = (intptr_t)&( ( idWindow * ) 0 )->background_parm11;
	}
	...
	for ( i = 0; i < c; i++ ) {
		...
		if ( dw && ( dw->win || dw->simp ) ){
			if ( dw->win ) {
				...
				} else if ( transitions[i].offset == (ptrdiff_t)&( ( idWindow * ) 0 )->background_parm11 ) {
				...
				} else if ( transitions[i].offset == (ptrdiff_t)&( ( idSimpleWindow * ) 0 )->background_parm11 ) {
