...
static void CreateFlashOff( void ) {
	...
	R_WriteTGA( "textures/images_used_in_source/lights/flashoff.tga", buffer, width, height );
...
void CreatePitFogImage( void ) {
	...
	R_WriteTGA( "textures/images_used_in_source/lights/fog_pit_falloff.tga", data[0][0], 16, 16 );
}
...
void CreatealphaSquareImage( void ) {
	...
	R_WriteTGA( "textures/images_used_in_source/lights/alpha_square.tga", data[0][0], 16, 16 );
}
