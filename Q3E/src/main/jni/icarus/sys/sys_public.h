...
#ifdef USE_SDL
#define AXIS_LEFT_X AXIS_SIDE
#define AXIS_LEFT_Y AXIS_FORWARD
#define AXIS_RIGHT_X AXIS_UP
#define AXIS_RIGHT_Y AXIS_ROLL
#define AXIS_LEFT_TRIG AXIS_YAW
#define AXIS_RIGHT_TRIG AXIS_PITCH

#define SE_JOYSTICK SE_JOYSTICK_AXIS
...
#ifdef _DIII4A //karin: system functions on Android
