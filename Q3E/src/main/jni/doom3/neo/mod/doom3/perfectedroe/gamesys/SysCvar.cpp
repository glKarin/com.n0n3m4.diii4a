...
// sikk---> Grabble Enemy Toggle
idCVar g_grabbableAI(				"g_grabbableAI",				"1",		CVAR_GAME | CVAR_NOCHEAT | CVAR_ARCHIVE | CVAR_BOOL,	"sets whether certain enemies can be grabbed with the grabber" );
// <---sikk
