...
void idPhysics_Player::UpdateLeanAngle (float deltaLeanTiltDegrees, float deltaLeanStretch)
{
    ...
    //DM_LOG(LC_MOVEMENT, LT_DEBUG)LOGSTRING("Collision trace between old view point ( %d, %d, %d ) and newPoint: ( %d, %d, %d )\r",
//origPoint.x, origPoint.y, origPoint.z, newPoint.x, newPoint.y, newPoint.z );
...
void idPhysics_Player::UpdateLeanedInputYaw( idAngles &InputAngles )
{
    ...
    **/
    ...
    //DM_LOG(LC_MOVEMENT,LT_DEBUG)LOGSTRING("Leaned View Yaw Test: Original viewpoint (%f, %f, %f) Tested viewpoint: (%f, %f, %f) \r",
//startPoint.x, startPoint.y, startPoint.z, endPoint.x, endPoint.y, endPoint.z );
    ...
    {
        //DM_LOG(LC_MOVEMENT,LT_DEBUG)LOGSTRING("Leaned View Yaw Test: Clipped with rotation trace fraction %f.  Delta yaw not allowed \r",
//TrResults.fraction );
...
//        {
//            //DM_LOG(LC_MOVEMENT,LT_DEBUG)LOGSTRING("Lean Into Door: Found empty space on other side of door.  Incidence point: %s Empty space
//point: %s \r", incidencePoint.ToString(), vTest.ToString() );
//
