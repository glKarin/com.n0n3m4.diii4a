...
CREATE_SHADOW_MAP_IMAGE_DECL(GLES2_2D_DEPTH, GenerateShadow2DDepthImage, (size, size, TF_LINEAR, true, TR_CLAMP_TO_ZERO_ALPHA))
CREATE_SHADOW_MAP_IMAGE_DECL(GLES2_CUBE_RGBA, GenerateShadowCubeRGBAImage, (size, TF_LINEAR, true, TR_CLAMP_TO_ZERO_ALPHA))
CREATE_SHADOW_MAP_IMAGE_DECL(GLES2_CUBE_DEPTH, GenerateShadowCubeDepthImage, (size, TF_LINEAR, true, TR_CLAMP_TO_ZERO_ALPHA))

#ifdef GL_ES_VERSION_3_0
CREATE_SHADOW_MAP_IMAGE_DECL(GLES3_2DARRAY_DEPTH, GenerateShadowArray, (size, size, 6, TF_LINEAR, TR_CLAMP_TO_ZERO_ALPHA))
#endif
// RB end
#endif
