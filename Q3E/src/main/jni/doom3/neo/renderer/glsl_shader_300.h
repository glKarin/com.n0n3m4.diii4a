...
"	#ifdef _HARM_POINT_LIGHT_FRUSTUM_FAR\n"
...
"		#ifndef _HARM_USING_FRAG_DEPTH\n"
"			float depth = length(var_LightToVertex) / u_uniformParm0;\n"
...
GLSL_SHADER const char ES3_INTERACTION_SHADOW_MAPPING_FRAG[] =
		...
		"   #ifdef _HARM_POINT_LIGHT_FRUSTUM_FAR\n"
		"	    uniform samplerCubeShadow u_fragmentCubeMap6;	/* u_shadowMapTexture */\n"
		"	    in highp vec3 var_LightToVertex;\n"
		"   #else\n"
		...
		"		float shadowDepth = texture(u_fragmentCubeMap6, vec4(normalize(var_LightToVertex + sampleOffsetTable[i] * u_uniformParm2), currentDepth));\n"
