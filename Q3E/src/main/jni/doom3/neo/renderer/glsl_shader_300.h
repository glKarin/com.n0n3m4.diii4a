...
"		out highp vec3 var_LightToVertex;\n"
"	#endif\n"
"#endif\n"
"\n"
"void main(void)\n"
...
"	highp vec4 pos = vec4(attr_Vertex.xyz, 1.0);\n"
"	highp vec4 var_FragCoord = pos * u_modelViewProjectionMatrix;\n"
"#ifdef _POINT_LIGHT\n"
"	#ifdef _POINT_LIGHT_USING_DISTANCE\n"
"		highp vec4 posWorld = u_modelMatrix * pos;\n"
...
"#ifdef _POINT_LIGHT\n"
"	#ifdef _POINT_LIGHT_USING_DISTANCE\n"
"		in highp vec3 var_LightToVertex;\n"
"	#endif\n"
"#endif\n"
"\n"
"out vec4 _gl_FragColor;\n"
...
"#ifdef _POINT_LIGHT\n"
"	#ifdef _POINT_LIGHT_USING_DISTANCE\n"
"		gl_FragDepth = length(var_LightToVertex) / u_uniformParm0;\n"
"	#endif\n"
"#endif\n"
"}\n"
;
...
GLSL_SHADER const char ES3_INTERACTION_SHADOW_MAPPING_FRAG[] =
		...
		"   #ifdef _POINT_LIGHT_USING_DISTANCE\n"
		"	    uniform highp samplerCubeShadow u_fragmentCubeMap6;	/* u_shadowMapTexture */\n"
		"	    in highp vec3 var_LightToVertex;\n"
		"   #else\n"
        ...
        "\n"
		"#ifdef _POINT_LIGHT_USING_DISTANCE\n"
        "	vec3 sampleOffsetTable[SAMPLES] = vec3[SAMPLES](\n"
		"	    vec3(0.0, 0.0, 0.0),\n"
		"	    vec3(1.0, 1.0, 1.0), vec3(1.0, 1.0, -1.0), vec3(1.0, -1.0, -1.0), vec3(1.0, -1.0, 1.0),\n"
		"	    vec3(-1.0, 1.0, 1.0), vec3(-1.0, -1.0, 1.0), vec3(-1.0, 1.0, -1.0), vec3(-1.0, -1.0, -1.0)\n"
        "   );\n"
		"	highp float currentDepth = BIAS(length(var_LightToVertex) / u_uniformParm0);\n"
        "   float distance = u_uniformParm2 + (length(var_LightToVertex) / 1000.0); // more far more large\n"
		"	for (int i = 0; i < SAMPLES; ++i) {\n"
		"		highp float shadowDepth = texture(u_fragmentCubeMap6, vec4(normalize(var_LightToVertex + sampleOffsetTable[i] * distance), currentDepth));\n"
