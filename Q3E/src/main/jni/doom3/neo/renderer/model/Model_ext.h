...
#define CONVERT_TO_MD5MESH_USAGE(x) "Usage: %s <" #x " file> [-scale <scale> -addOrigin -offset <\"x-axis y-axis z-axis\"> -rotation <\"pitch yaw roll\">\n"
#define CONVERT_TO_MD5_USAGE(x, y) "Usage: %s <" #x " file> [-scale <scale> -addOrigin -offset <\"x-axis y-axis z-axis\"> -rotation <\"pitch yaw roll\"> [-animation] <" #y ">......]\n"
#define CONVERT_TO_MD5ANIM_USAGE(x, y) CONVERT_TO_MD5_USAGE(x, y)
#define CONVERT_TO_MD5_ALL_USAGE(x) "Usage: %s <" #x " file> [-scale <scale> -addOrigin -offset <\"x-axis y-axis z-axis\"> -rotation <\"pitch yaw roll\"> [ [-animation] <animation name or index>......] ]\n"
