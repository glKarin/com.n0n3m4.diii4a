...
"\n"
"uniform highp vec4 u_globalLightOrigin;\n"
...
"	var_FragPosition = posWorld.xyz / posWorld.w - u_globalLightOrigin.xyz / u_globalLightOrigin.w;\n"
"#else\n"
...
"    return length(Vec) / u_far;\n"
"#else\n"
"    vec3 AbsVec = abs(Vec);\n"
"    float LocalZcomp = max(AbsVec.x, max(AbsVec.y, AbsVec.z));\n"
"    float NormZComp = (u_far+u_near) / (u_far-u_near) - (2.0*u_far*u_near)/(u_far-u_near)/LocalZcomp;\n"
...
static const char INTERACTION_SHADOW_MAPPING_VERT[] =
        ...
        "uniform highp mat4 u_modelViewProjectionMatrix;\n"
		"\n"
		"uniform highp mat4 u_shadowMVPMatrix;\n"
		"uniform highp mat4 u_modelMatrix;\n"
		"uniform highp vec4 u_globalLightOrigin;\n"
		"\n"
		"#ifdef _HARM_POINT_LIGHT\n"
		...
		"	var_FragPosition = posInLight.xyz / posInLight.w - u_globalLightOrigin.xyz / u_globalLightOrigin.w;\n"
		"#else\n"
        "	var_DepthCoord = attr_Vertex * u_shadowMVPMatrix;\n"
		"#endif\n"
        "	gl_Position = u_modelViewProjectionMatrix * attr_Vertex;\n"
        "}\n"
;
static const char INTERACTION_SHADOW_MAPPING_FRAG[] =
        ...
        "uniform sampler2D u_fragmentMap5;	/* u_specularFalloffTexture */\n"
		"#ifdef _HARM_POINT_LIGHT\n"
        "uniform samplerCube u_fragmentMap6;	/* u_shadowMapTexture */\n"
		"#else\n"
		...
		"uniform lowp float u_bias;\n"
        "uniform lowp float u_sampleSize;\n"
		"\n"
		"#ifdef _HARM_POINT_LIGHT\n"
		"varying highp vec3 var_FragPosition;\n"
		"#else\n"
		...
		"		float closestDepth = textureCube(u_fragmentMap6, var_FragPosition + sampleOffsetTable[i] * u_sampleSize).r;\n"
		"		float visibility = currentDepth - u_bias - closestDepth;\n"
		"		shadow += 1.0 - step(visibility, 0.0) * u_alpha;\n"
		"		//shadow += visibility > 0.0 ? 1.0 : u_alpha;\n"
		"	}\n"
		"#else\n"
		"#define SAMPLES 9\n"
		...
		"	shadowMapPosition = (shadowMapPosition + 1.0) * 0.5;\n"
		" \n"
		"	for (int i = 0; i < SAMPLES; ++i) {\n"
		"		vec4 packedZValue = texture2D(u_fragmentMap6, shadowMapPosition.st + sampleOffsetTable[i] * u_sampleSize);\n"
		"		float distanceFromLight = packedZValue.r; //unpack(packedZValue);\n"
		"		float visibility = (shadowMapPosition.z - u_bias) - distanceFromLight;\n"
		"		shadow += 1.0 - step(0.0, visibility) * u_alpha;\n"
		"		//shadow += visibility <= 0.0 ? 1.0 : u_alpha;\n"
		"	}\n"
		"#endif\n"
