...
GLSL_SHADER const char ES3_INTERACTION_SHADOW_MAPPING_FRAG[] =
        ...
        "	highp float distance = u_uniformParm2 + length(var_VertexToLight) * (0.00000000001 * u_uniformParm6);\n"
		"#else\n"
        "	highp float distance = u_uniformParm2 + length(var_VertexToLight) / (100000000000.0 * u_uniformParm5);\n"
		"#endif\n"
		"#else\n"
