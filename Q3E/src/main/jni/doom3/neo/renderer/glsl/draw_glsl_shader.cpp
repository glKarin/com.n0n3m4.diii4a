...
#define GLSL2_SHADOW_MAPPING_COLOR_MACROS(type) r_usePackColorAsDepth ? type ",_PACK_FLOAT" : type
	...
	ret.Append(GLSL_SHADER_SOURCE("interactionTranslucent", SHADER_INTERACTIONTRANSLUCENT, &interactionTranslucentShader, INTERACTION_TRANSLUCENT_VERT, INTERACTION_TRANSLUCENT_FRAG, "PHONG", "PHONG"));
	ret.Append(GLSL_SHADER_SOURCE("interactionPBRTranslucent", SHADER_INTERACTIONPBRTRANSLUCENT, &interactionPBRTranslucentShader, INTERACTION_TRANSLUCENT_VERT, INTERACTION_TRANSLUCENT_FRAG, "_PBR", "_PBR"));
	...
	ret.Append(GLSL_SHADER_SOURCE("interactionSoft", SHADER_INTERACTIONSOFT, &interactionSoftShader, INTERACTION_SOFT_VERT, INTERACTION_SOFT_FRAG, "PHONG", "PHONG"));
	ret.Append(GLSL_SHADER_SOURCE("interactionPBRSoft", SHADER_INTERACTIONPBRSOFT, &interactionPBRSoftShader, INTERACTION_SOFT_VERT, INTERACTION_SOFT_FRAG, "_PBR", "_PBR"));
