...
GLSL_SHADER const char INTERACTION_SHADOW_MAPPING_FRAG[] =
        ...
        "    float random = texture2D( u_fragmentMap7, gl_FragCoord.xy * SCREEN_SIZE_MULTIPLICATOR ).r;\n"
        ...
        "        highp float shadowDepth = DC(textureCube(u_fragmentCubeMap6, normalize(texcoordCube + jitterRotated * distance)));\n"
