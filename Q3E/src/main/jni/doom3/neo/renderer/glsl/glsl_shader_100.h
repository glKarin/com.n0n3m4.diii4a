...
#define SAMPLE_POISSON_DISK_TYPE 0
#if SAMPLE_POISSON_DISK_TYPE == 1
...
#elif SAMPLE_POISSON_DISK_TYPE == 2
#define SAMPLE_POISSON_DISK \
        "#define SAMPLES 13\n" \
        "vec2 sampleOffsetTable[SAMPLES];\n"\
...
GLSL_SHADER const char INTERACTION_SHADOW_MAPPING_FRAG[] =
		...
		"#if 1 // more far more large\n"
        "   highp float distance = u_uniformParm2 + length(var_LightToVertex) * (0.000001 * u_uniformParm6);\n"
		"#else\n"
        "   highp float distance = u_uniformParm2 + length(var_LightToVertex) / (1000000.0 * u_uniformParm5);\n"
		"#endif\n"
