...
"   #if defined(_POINT_LIGHT_USING_DISTANCE) || defined(_POINT_LIGHT_CALC_Z)\n"
...
"   #ifdef _POINT_LIGHT\n"
"		float depth;\n"
"	    #ifdef _POINT_LIGHT_USING_DISTANCE\n"
"		    depth = length(var_LightToVertex) / u_uniformParm0;\n"
"		    gl_FragDepthEXT = depth;\n"
"	    #elif defined(_POINT_LIGHT_CALC_Z)\n"
...
GLSL_SHADER const char INTERACTION_SHADOW_MAPPING_VERT[] =
		...
		"	    var_LightToVertex = posInLight.xyz - globalLightOrigin.xyz;\n"
        "		#ifdef _DISTANCE_IN_VERTEX_SHADER\n"
		"			var_Distance = length(var_LightToVertex) / u_uniformParm0;\n"
        "		#endif\n"
        "   #endif\n"
		"#else\n"
