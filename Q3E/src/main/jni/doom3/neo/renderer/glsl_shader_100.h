...
"		gl_Position = var_FragCoord;\n"
"	#else\n"
"	    pos = vec4(attr_Vertex.xyz, 1.0);\n"
"		vec4 posWorld = u_modelMatrix * pos;\n"
"		var_LightToVertex = posWorld.xyz - globalLightOrigin.xyz;\n"
"		vec4 var_FragCoord = pos * u_modelViewProjectionMatrix;\n"
"		#ifdef _USING_DEPTH_TEXTURE\n"
"			#ifdef _POINT_LIGHT_CALC_Z\n"
"				float depth = VectorToDepthValue(var_LightToVertex);\n"
"			#else\n"
"				float depth = (length(var_LightToVertex) - u_uniformParm1) / (u_uniformParm0 - u_uniformParm1);\n"
"			#endif\n"
"			var_FragCoord.z = (depth * 2.0 - 1.0) * var_FragCoord.w;\n"
"		#endif\n"
"		gl_Position = var_FragCoord;\n"
"	#endif\n"
"#else\n"
...
"	    #elif defined(_POINT_LIGHT_USING_DISTANCE)\n"
...
"		    //gl_FragDepthEXT = depth;\n"
"	    #endif\n"
"   #elif defined(_PARALLEL_LIGHT)\n"
"	    depth = ((var_FragCoord.z / var_FragCoord.w) + 1.0) * 0.5;\n"
"   #else\n"
"	    depth = var_FragCoord.z / var_FragCoord.w;\n"
"   #endif\n"
"\n"
"   gl_FragColor = vec4(depth, 0.0, 0.0, 1.0); // gl_FragColor = depth < 1.0 ? pack(depth) : vec4(1.0, 1.0, 1.0, 1.0);\n"
"#endif\n"
"}\n"
;
...
GLSL_SHADER const char INTERACTION_SHADOW_MAPPING_VERT[] =
		...
		"	#else\n"
        "		#ifdef _DISTANCE_IN_VERTEX_SHADER\n"
		"			varying highp float var_Distance;\n"
		"			uniform highp float u_uniformParm0; // frustum z-far\n"
		"			uniform highp float u_uniformParm1; // frustum z-near\n"
		"		#endif\n"
		"	#endif\n"
		...
		"	    var_LightToVertex = posInLight.xyz - globalLightOrigin.xyz;\n"
        "		#ifdef _DISTANCE_IN_VERTEX_SHADER\n"
		"			var_Distance = (length(var_LightToVertex) - u_uniformParm1) / (u_uniformParm0 - u_uniformParm1);\n"
        "		#endif\n"
        "   #endif\n"
		"#else\n"
...
GLSL_SHADER const char INTERACTION_SHADOW_MAPPING_FRAG[] =
        ...
        "		#ifdef _DYNAMIC_BIAS\n"
        "			#ifdef _DISTANCE_IN_VERTEX_SHADER\n"
		"				float currentDepth = var_Distance * BIAS_SCALE;\n"
        "			#else\n"
		"		    	float currentDepth = (length(var_LightToVertex) - u_uniformParm1) / (u_uniformParm0 - u_uniformParm1) * BIAS_SCALE;\n"
        "			#endif\n"
        "   	#else\n"
        "			#ifdef _DISTANCE_IN_VERTEX_SHADER\n"
		"				float currentDepth = var_Distance - BIAS;\n"
        "			#else\n"
		"				float currentDepth = (length(var_LightToVertex) - u_uniformParm1) / (u_uniformParm0 - u_uniformParm1) - BIAS;\n"
        "			#endif\n"
        "   	#endif\n"
		"		for (int i = 0; i < SAMPLES; ++i) {\n"
		"			float shadowDepth = textureCube(u_fragmentCubeMap6, normalize(var_LightToVertex + sampleOffsetTable[i] * u_uniformParm2)).r;\n"
