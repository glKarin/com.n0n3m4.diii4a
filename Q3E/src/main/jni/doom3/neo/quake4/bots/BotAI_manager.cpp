...
bool botAi::GenerateAAS(void)
{
    ...
    gameLocal.Printf("[Harmattan]: Check AAS '" BOT_AAS "' load result......\n");
    ...
    {
        gameLocal.Printf("[Harmattan]: AAS '" BOT_AAS "' not setting %s.\n", aasLoadSuc ? "success" : "fail");
        return false;
    }
    gameLocal.Printf("[Harmattan]: AAS '" BOT_AAS "' load %s.\n", aasLoadSuc ? "success" : "fail");

    if(!aasLoadSuc) {
        gameLocal.Printf("[Harmattan]: Check AAS '" BOT_AAS "' file exists......\n");
