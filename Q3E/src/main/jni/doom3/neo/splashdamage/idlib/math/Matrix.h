...
ID_INLINE void idMat5::Identity( void ) {
	mat[ 0 ].x = 1.0f; mat[ 0 ].y = 0.0f; mat[ 0 ].z = 0.0f; mat[ 0 ].s = 0.0f; mat[ 0 ].t = 0.0f;
	mat[ 1 ].x = 0.0f; mat[ 1 ].y = 1.0f; mat[ 1 ].z = 0.0f; mat[ 1 ].s = 0.0f; mat[ 1 ].t = 0.0f;
	mat[ 2 ].x = 0.0f; mat[ 2 ].y = 0.0f; mat[ 2 ].z = 1.0f; mat[ 2 ].s = 0.0f; mat[ 2 ].t = 0.0f;
	mat[ 3 ].x = 0.0f; mat[ 3 ].y = 0.0f; mat[ 3 ].z = 0.0f; mat[ 3 ].s = 1.0f; mat[ 3 ].t = 0.0f;
	mat[ 4 ].x = 0.0f; mat[ 4 ].y = 0.0f; mat[ 4 ].z = 0.0f; mat[ 4 ].s = 0.0f; mat[ 4 ].t = 1.0f;
}
...
ID_INLINE void idMat6::Identity( void ) {
	mat[ 0 ][ 0 ] = 1.0f; mat[ 0 ][ 1 ] = 0.0f; mat[ 0 ][ 2 ]= 0.0f; mat[ 0 ][ 3 ] = 0.0f; mat[ 0 ][ 4 ] = 0.0f; mat[ 0 ][ 5 ] = 0.0f;
	mat[ 1 ][ 0 ] = 0.0f; mat[ 1 ][ 1 ] = 1.0f; mat[ 1 ][ 2 ]= 0.0f; mat[ 1 ][ 3 ] = 0.0f; mat[ 1 ][ 4 ] = 0.0f; mat[ 1 ][ 5 ] = 0.0f;
	mat[ 2 ][ 0 ] = 0.0f; mat[ 2 ][ 1 ] = 0.0f; mat[ 2 ][ 2 ]= 1.0f; mat[ 2 ][ 3 ] = 0.0f; mat[ 2 ][ 4 ] = 0.0f; mat[ 2 ][ 5 ] = 0.0f;
	mat[ 3 ][ 0 ] = 0.0f; mat[ 3 ][ 1 ] = 0.0f; mat[ 3 ][ 2 ]= 0.0f; mat[ 3 ][ 3 ] = 1.0f; mat[ 3 ][ 4 ] = 0.0f; mat[ 3 ][ 5 ] = 0.0f;
	mat[ 4 ][ 0 ] = 0.0f; mat[ 4 ][ 1 ] = 0.0f; mat[ 4 ][ 2 ]= 0.0f; mat[ 4 ][ 3 ] = 0.0f; mat[ 4 ][ 4 ] = 1.0f; mat[ 4 ][ 5 ] = 0.0f;
	mat[ 5 ][ 0 ] = 0.0f; mat[ 5 ][ 1 ] = 0.0f; mat[ 5 ][ 2 ]= 0.0f; mat[ 5 ][ 3 ] = 0.0f; mat[ 5 ][ 4 ] = 0.0f; mat[ 5 ][ 5 ] = 1.0f;
}
