...
idCVar g_skill(						"g_skill",					"2",			CVAR_GAME | CVAR_INTEGER, "" );
...
idCVar g_wallHide(			"g_wallHide",			"1",			CVAR_GAME | CVAR_BOOL, "Hide gun when approaching a wall" );
...
idCVar g_skipViewEffects(			"g_skipViewEffects",
#ifdef _OVERTHINKED //karin: not support vision effect
                                     "1"
#else
                                     "0"
#endif
                                     ,			CVAR_GAME | CVAR_ARCHIVE | CVAR_BOOL, "skip damage and other view effects" );
...
//0x29a
idCVar g_bloodAmount(			"g_bloodAmount",			"3",		CVAR_GAME | CVAR_NOCHEAT | CVAR_ARCHIVE | CVAR_INTEGER,	"amount of blood splatter when gibbing Zombies" );
...
idCVar g_healthManagementType(		"g_healthManagementType",		"1",		CVAR_GAME | CVAR_NOCHEAT | CVAR_ARCHIVE | CVAR_INTEGER,	"selects which health management system to use. 0 = default; 1 = carriable health pack; 2 = regenerating health" );
...
idCVar g_healthPackTime(			"g_healthPackTime",				"6",		CVAR_GAME | CVAR_NOCHEAT | CVAR_ARCHIVE | CVAR_INTEGER,	"maximum time it takes to heal yourself. " );
...
idCVar g_itemValueFactor(			"g_itemValueFactor",			"1.0",		CVAR_GAME | CVAR_NOCHEAT | CVAR_ARCHIVE | CVAR_FLOAT,	"sets the factor for which the value for items are randomly set. Value Range: 0.0 (items have full value) - 1.0 (items have anywhere from one to full value)" );
