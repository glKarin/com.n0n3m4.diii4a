...
public:
    ...
    void					BeginMeleeFunction( bool );	// Added by 0x29a
...
// sikk---> Soft Shadows PostProcess
    ...
    renderLight_t*          GetWorldMuzzleFlash( void )
    {
        return &worldMuzzleFlash;
    };
    int                     GetMuzzleFlashHandle( void )
    {
        return muzzleFlashHandle;
    };
    int                     GetWorldMuzzleFlashHandle( void )
    {
...
private:
    ...
    idScriptBool			WEAPON_MELEE;  // For weapon special function, added by clone JCD
    ...
    */
    ...
    void					Event_UseBullet();
    void					Event_AddToClip( int amount, int secondAmount, int reuse );
    void					Event_AmmoInClip(void);
    void					Event_UpdateWallHide( void );
