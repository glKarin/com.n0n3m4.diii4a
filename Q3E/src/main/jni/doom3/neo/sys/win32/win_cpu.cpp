...
bool GetCPUInfo( cpuInfo_t & cpuInfo ) {
    ...
    while ( byteOffset + sizeof(SYSTEM_LOGICAL_PROCESSOR_INFORMATION) <= returnLength ) {
        switch ( (LOGICAL_PROCESSOR_RELATIONSHIP_LOCAL) ptr->Relationship ) {
            ...
            default:
                printf( "Error: Unsupported LOGICAL_PROCESSOR_RELATIONSHIP value.\n" );
                break;
        }
...
void Sys_Win_CPUCount( int& numLogicalCPUCores, int& numPhysicalCPUCores, int& numCPUPackages )
{
    ...
    printf("Sys_Win_CPUCount: numLogicalCPUCores = %d, numPhysicalCPUCores = %d, numCPUPackages = %d\n", numLogicalCPUCores, numPhysicalCPUCores, numCPUPackages);
}
