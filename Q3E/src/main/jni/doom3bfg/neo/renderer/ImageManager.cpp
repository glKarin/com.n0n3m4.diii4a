...
void idImageManager::Init()
{
	...
	samplerHash.Resize(SHARED_SAMPLERS_INITIALIZE_SIZE, SHARED_SAMPLERS_INITIALIZE_GRANULARITY);
	samplerList.Resize(SHARED_SAMPLERS_INITIALIZE_SIZE, SHARED_SAMPLERS_INITIALIZE_GRANULARITY);
#endif
