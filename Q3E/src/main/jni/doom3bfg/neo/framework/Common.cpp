...
#else
#ifdef __ANDROID__ //karin: com_allowConsole allow write cfg file
	idCVar com_allowConsole( "com_allowConsole", "1", CVAR_BOOL | CVAR_SYSTEM | CVAR_ARCHIVE, "allow toggling console with the tilde key" );
#else
