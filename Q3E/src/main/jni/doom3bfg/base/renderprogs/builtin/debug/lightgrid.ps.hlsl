...
void main( PS_IN fragment, out PS_OUT result )
{
	...
	normalizedOctCoordZeroOne.x += float( gridCoord[0] * gridStep[0] + gridCoord[2] * gridStep[1] ) * invXZ;
	normalizedOctCoordZeroOne.y += ( float(gridCoord[1]) * invY );
	...
	probeTopLeftPosition.x = float( gridCoord[0] * gridStep[0] + gridCoord[2] * gridStep[1] ) * rpScreenCorrectionFactor.z + rpScreenCorrectionFactor.z * 0.5;
	probeTopLeftPosition.y = float( gridCoord[1] ) * rpScreenCorrectionFactor.z + rpScreenCorrectionFactor.z * 0.5;
