...
#ifdef _GLES //karin: TODO crash when call qglStencilOpSeparate
...
#ifdef _GLES //karin: glReadPixels GL_RGBA
	packAlign = 1;
#else
...
void RE_Shutdown( qboolean destroyWindow, qboolean restarting ) {
	...
	{
#if !defined(_GLES) //karin: not support arb program and list
