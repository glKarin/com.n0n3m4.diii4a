add_library(${OPENMOHAA_TARGET_PREFIX}qcommon_version INTERFACE)

if(ANDROID)
	set(GIT_BRANCH_NAME "main")
	set(GIT_REVISION_HASH "a72bc153db1e6ced6e30431b5217e1a53576712c")
	set(GIT_REVISION_DATE "Aug 3 2025")
	set(GIT_REVISION_BUILD_NUMBER 1)
	set(PRODUCT_VERSION_STAGE "stable")
else()
execute_process(
...
target_include_directories(${OPENMOHAA_TARGET_PREFIX}qcommon_version INTERFACE "${CMAKE_CURRENT_BINARY_DIR}/generated")
