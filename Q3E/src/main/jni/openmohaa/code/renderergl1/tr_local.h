...
#ifdef __ANDROID__ //karin: GLES1.1 compat macros
#if !defined(_GLES_DISABLE_COMPAT)
#define qglClipPlane qglClipPlanef
#define qglClipDepth qglClipDepthf
#define qglDepthRange qglDepthRangef
#define qglOrtho qglOrthof
#define qglFrustum qglFrustumf
#define qglPolygonMode(...)
#define qglColor3f(r, g, b) qglColor4f(r, g, b, 1.0f)
#define qglFogi qglFogf
