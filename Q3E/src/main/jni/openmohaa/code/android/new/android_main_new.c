...
#define LIB_PREFIX "omoh"

extern char * Android_GetClipboardData(void);
extern void Android_SetClipboardData(const char *);
...
void Sys_SetClipboard(const char *contents)
{
    ...
    Android_SetClipboardData(contents);
#endif
}
...
void* Sys_GetGameAPI(void* parms)
{
    ...
    const char* gamename = LIB_PREFIX "game" DLL_SUFFIX DLL_EXT;
...
void* Sys_GetCGameAPI(void* parms)
{
    ...
    const char* gamename = LIB_PREFIX "cgame" DLL_SUFFIX DLL_EXT;
