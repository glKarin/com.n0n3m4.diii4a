...
static void close_gl(void) {
    printf("EGL::close_gl: do nothing\n");
}
#else
#include <dlfcn.h>
static void* libGL;
...
#else
#define droidGetProcAddress eglGetProcAddress
#endif
#endif
...
#include <dlfcn.h>
#endif
static void * GLimp_Load(GLADloadproc _load, const char *name)
{
    void *result = _load(name);
    if(!result)
    {
#if 0 //TODO: load customer implements, e.g. glClearDepth, glDepthRange
        result = dlsym(RTLD_NEXT, name);
        printf("Using stub: %s -> %p\n", name, result);
        if(!result)
        {
            fprintf(stderr, "Missing stub: %s\n", name);
            result = GLimp_FunctionPlaceholder;
        }
#else
		result = GLimp_FunctionPlaceholder;
        printf("Using stub: %s -> %p\n", name, result);
...
#define load(name) GLimp_Load(_load, name)
#else
#define load(x) _load(x)
#endif

static void load_GL_VERSION_1_0(GLADloadproc _load) {
...
static void load_GL_VERSION_1_1(GLADloadproc _load) {
...
static void load_GL_VERSION_1_2(GLADloadproc _load) {
...
static void load_GL_VERSION_1_3(GLADloadproc _load) {
...
static void load_GL_VERSION_1_4(GLADloadproc _load) {
...
static void load_GL_VERSION_1_5(GLADloadproc _load) {
...
static void load_GL_VERSION_2_0(GLADloadproc _load) {
...
static void load_GL_VERSION_2_1(GLADloadproc _load) {
...
static void load_GL_VERSION_3_0(GLADloadproc _load) {
...
static void load_GL_VERSION_3_1(GLADloadproc _load) {
...
static void load_GL_VERSION_3_2(GLADloadproc _load) {
...
static void load_GL_VERSION_3_3(GLADloadproc _load) {
...
static void load_GL_3DFX_tbuffer(GLADloadproc _load) {
	if(!GLAD_GL_3DFX_tbuffer) return;
	glad_glTbufferMask3DFX = (PFNGLTBUFFERMASK3DFXPROC)load("glTbufferMask3DFX");
}
static void load_GL_AMD_debug_output(GLADloadproc _load) {
...
static void load_GL_AMD_draw_buffers_blend(GLADloadproc _load) {
...
static void load_GL_AMD_framebuffer_multisample_advanced(GLADloadproc _load) {
...
static void load_GL_AMD_framebuffer_sample_positions(GLADloadproc _load) {
...
static void load_GL_AMD_gpu_shader_int64(GLADloadproc _load) {
...
static void load_GL_AMD_interleaved_elements(GLADloadproc _load) {
...
static void load_GL_AMD_multi_draw_indirect(GLADloadproc _load) {
...
static void load_GL_AMD_name_gen_delete(GLADloadproc _load) {
...
static void load_GL_AMD_occlusion_query_event(GLADloadproc _load) {
...
static void load_GL_AMD_performance_monitor(GLADloadproc _load) {
...
static void load_GL_AMD_stencil_operation_extended(GLADloadproc _load) {
...
static void load_GL_AMD_vertex_shader_tessellator(GLADloadproc _load) {
...
static void load_GL_APPLE_element_array(GLADloadproc _load) {
...
static void load_GL_APPLE_fence(GLADloadproc _load) {
...
static void load_GL_APPLE_flush_buffer_range(GLADloadproc _load) {
...
static void load_GL_APPLE_object_purgeable(GLADloadproc _load) {
...
static void load_GL_APPLE_texture_range(GLADloadproc _load) {
...
static void load_GL_APPLE_vertex_array_object(GLADloadproc _load) {
...
static void load_GL_APPLE_vertex_array_range(GLADloadproc _load) {
...
static void load_GL_APPLE_vertex_program_evaluators(GLADloadproc _load) {
...
static void load_GL_ARB_ES2_compatibility(GLADloadproc _load) {
...
static void load_GL_ARB_ES3_1_compatibility(GLADloadproc _load) {
	if(!GLAD_GL_ARB_ES3_1_compatibility) return;
	glad_glMemoryBarrierByRegion = (PFNGLMEMORYBARRIERBYREGIONPROC)load("glMemoryBarrierByRegion");
}
static void load_GL_ARB_ES3_2_compatibility(GLADloadproc _load) {
...
static void load_GL_ARB_base_instance(GLADloadproc _load) {
...
static void load_GL_ARB_bindless_texture(GLADloadproc _load) {
...
static void load_GL_ARB_blend_func_extended(GLADloadproc _load) {
	if(!GLAD_GL_ARB_blend_func_extended) return;
	glad_glBindFragDataLocationIndexed = (PFNGLBINDFRAGDATALOCATIONINDEXEDPROC)load("glBindFragDataLocationIndexed");
	glad_glGetFragDataIndex = (PFNGLGETFRAGDATAINDEXPROC)load("glGetFragDataIndex");
}
static void load_GL_ARB_buffer_storage(GLADloadproc _load) {
	if(!GLAD_GL_ARB_buffer_storage) return;
	glad_glBufferStorage = (PFNGLBUFFERSTORAGEPROC)load("glBufferStorage");
}
static void load_GL_ARB_cl_event(GLADloadproc _load) {
...
static void load_GL_ARB_clear_buffer_object(GLADloadproc _load) {
...
static void load_GL_ARB_copy_buffer(GLADloadproc _load) {
	if(!GLAD_GL_ARB_copy_buffer) return;
	glad_glCopyBufferSubData = (PFNGLCOPYBUFFERSUBDATAPROC)load("glCopyBufferSubData");
}
static void load_GL_ARB_copy_image(GLADloadproc _load) {
	if(!GLAD_GL_ARB_copy_image) return;
	glad_glCopyImageSubData = (PFNGLCOPYIMAGESUBDATAPROC)load("glCopyImageSubData");
}
static void load_GL_ARB_debug_output(GLADloadproc _load) {
...
static void load_GL_ARB_direct_state_access(GLADloadproc _load) {
...
static void load_GL_ARB_draw_buffers(GLADloadproc _load) {
	if(!GLAD_GL_ARB_draw_buffers) return;
	glad_glDrawBuffersARB = (PFNGLDRAWBUFFERSARBPROC)load("glDrawBuffersARB");
}
static void load_GL_ARB_draw_buffers_blend(GLADloadproc _load) {
...
static void load_GL_ARB_draw_elements_base_vertex(GLADloadproc _load) {
...
static void load_GL_ARB_draw_indirect(GLADloadproc _load) {
	if(!GLAD_GL_ARB_draw_indirect) return;
	glad_glDrawArraysIndirect = (PFNGLDRAWARRAYSINDIRECTPROC)load("glDrawArraysIndirect");
	glad_glDrawElementsIndirect = (PFNGLDRAWELEMENTSINDIRECTPROC)load("glDrawElementsIndirect");
}
static void load_GL_ARB_draw_instanced(GLADloadproc _load) {
...
static void load_GL_ARB_fragment_program(GLADloadproc _load) {
...
static void load_GL_ARB_framebuffer_no_attachments(GLADloadproc _load) {
...
static void load_GL_ARB_framebuffer_object(GLADloadproc _load) {
...
static void load_GL_ARB_geometry_shader4(GLADloadproc _load) {
...
static void load_GL_ARB_get_program_binary(GLADloadproc _load) {
	if(!GLAD_GL_ARB_get_program_binary) return;
	glad_glGetProgramBinary = (PFNGLGETPROGRAMBINARYPROC)load("glGetProgramBinary");
	glad_glProgramBinary = (PFNGLPROGRAMBINARYPROC)load("glProgramBinary");
	glad_glProgramParameteri = (PFNGLPROGRAMPARAMETERIPROC)load("glProgramParameteri");
}
static void load_GL_ARB_get_texture_sub_image(GLADloadproc _load) {
...
static void load_GL_ARB_gpu_shader_int64(GLADloadproc _load) {
...
static void load_GL_ARB_imaging(GLADloadproc _load) {
...
static void load_GL_ARB_indirect_parameters(GLADloadproc _load) {
...
static void load_GL_ARB_instanced_arrays(GLADloadproc _load) {
...
static void load_GL_ARB_internalformat_query(GLADloadproc _load) {
	if(!GLAD_GL_ARB_internalformat_query) return;
	glad_glGetInternalformativ = (PFNGLGETINTERNALFORMATIVPROC)load("glGetInternalformativ");
}
static void load_GL_ARB_internalformat_query2(GLADloadproc _load) {
...
static void load_GL_ARB_invalidate_subdata(GLADloadproc _load) {
...
static void load_GL_ARB_map_buffer_range(GLADloadproc _load) {
	if(!GLAD_GL_ARB_map_buffer_range) return;
	glad_glMapBufferRange = (PFNGLMAPBUFFERRANGEPROC)load("glMapBufferRange");
	glad_glFlushMappedBufferRange = (PFNGLFLUSHMAPPEDBUFFERRANGEPROC)load("glFlushMappedBufferRange");
}
static void load_GL_ARB_matrix_palette(GLADloadproc _load) {
...
static void load_GL_ARB_multi_bind(GLADloadproc _load) {
...
static void load_GL_ARB_multi_draw_indirect(GLADloadproc _load) {
...
static void load_GL_ARB_multisample(GLADloadproc _load) {
	if(!GLAD_GL_ARB_multisample) return;
	glad_glSampleCoverageARB = (PFNGLSAMPLECOVERAGEARBPROC)load("glSampleCoverageARB");
}
static void load_GL_ARB_multitexture(GLADloadproc _load) {
...
static void load_GL_ARB_occlusion_query(GLADloadproc _load) {
...
static void load_GL_ARB_parallel_shader_compile(GLADloadproc _load) {
...
static void load_GL_ARB_point_parameters(GLADloadproc _load) {
...
static void load_GL_ARB_polygon_offset_clamp(GLADloadproc _load) {
...
static void load_GL_ARB_program_interface_query(GLADloadproc _load) {
...
static void load_GL_ARB_provoking_vertex(GLADloadproc _load) {
	if(!GLAD_GL_ARB_provoking_vertex) return;
	glad_glProvokingVertex = (PFNGLPROVOKINGVERTEXPROC)load("glProvokingVertex");
}
static void load_GL_ARB_robustness(GLADloadproc _load) {
...
static void load_GL_ARB_sample_locations(GLADloadproc _load) {
...
static void load_GL_ARB_separate_shader_objects(GLADloadproc _load) {
...
static void load_GL_ARB_shader_atomic_counters(GLADloadproc _load) {
...
static void load_GL_ARB_shader_image_load_store(GLADloadproc _load) {
	if(!GLAD_GL_ARB_shader_image_load_store) return;
	glad_glBindImageTexture = (PFNGLBINDIMAGETEXTUREPROC)load("glBindImageTexture");
	glad_glMemoryBarrier = (PFNGLMEMORYBARRIERPROC)load("glMemoryBarrier");
}
static void load_GL_ARB_shader_objects(GLADloadproc _load) {
...
static void load_GL_ARB_shader_storage_buffer_object(GLADloadproc _load) {
...
static void load_GL_ARB_shader_subroutine(GLADloadproc _load) {
...
static void load_GL_ARB_shading_language_include(GLADloadproc _load) {
...
static void load_GL_ARB_sparse_buffer(GLADloadproc _load) {
...
static void load_GL_ARB_sparse_texture(GLADloadproc _load) {
...
static void load_GL_ARB_sync(GLADloadproc _load) {
...
static void load_GL_ARB_tessellation_shader(GLADloadproc _load) {
...
static void load_GL_ARB_texture_multisample(GLADloadproc _load) {
...
static void load_GL_ARB_texture_storage(GLADloadproc _load) {
	if(!GLAD_GL_ARB_texture_storage) return;
	glad_glTexStorage1D = (PFNGLTEXSTORAGE1DPROC)load("glTexStorage1D");
	glad_glTexStorage2D = (PFNGLTEXSTORAGE2DPROC)load("glTexStorage2D");
	glad_glTexStorage3D = (PFNGLTEXSTORAGE3DPROC)load("glTexStorage3D");
}
static void load_GL_ARB_texture_storage_multisample(GLADloadproc _load) {
...
static void load_GL_ARB_texture_view(GLADloadproc _load) {
	if(!GLAD_GL_ARB_texture_view) return;
	glad_glTextureView = (PFNGLTEXTUREVIEWPROC)load("glTextureView");
}
static void load_GL_ARB_timer_query(GLADloadproc _load) {
	if(!GLAD_GL_ARB_timer_query) return;
	glad_glQueryCounter = (PFNGLQUERYCOUNTERPROC)load("glQueryCounter");
	glad_glGetQueryObjecti64v = (PFNGLGETQUERYOBJECTI64VPROC)load("glGetQueryObjecti64v");
	glad_glGetQueryObjectui64v = (PFNGLGETQUERYOBJECTUI64VPROC)load("glGetQueryObjectui64v");
}
static void load_GL_ARB_transform_feedback2(GLADloadproc _load) {
...
static void load_GL_ARB_transform_feedback3(GLADloadproc _load) {
...
static void load_GL_ARB_transform_feedback_instanced(GLADloadproc _load) {
...
static void load_GL_ARB_transpose_matrix(GLADloadproc _load) {
...
static void load_GL_ARB_uniform_buffer_object(GLADloadproc _load) {
...
static void load_GL_ARB_vertex_array_object(GLADloadproc _load) {
...
static void load_GL_ARB_vertex_attrib_64bit(GLADloadproc _load) {
...
static void load_GL_ARB_vertex_attrib_binding(GLADloadproc _load) {
...
static void load_GL_ARB_vertex_blend(GLADloadproc _load) {
...
static void load_GL_ARB_vertex_buffer_object(GLADloadproc _load) {
...
static void load_GL_ARB_vertex_program(GLADloadproc _load) {
...
static void load_GL_ARB_vertex_shader(GLADloadproc _load) {
...
static void load_GL_ARB_vertex_type_2_10_10_10_rev(GLADloadproc _load) {
...
static void load_GL_ARB_viewport_array(GLADloadproc _load) {
...
static void load_GL_ARB_window_pos(GLADloadproc _load) {
...
static void load_GL_ATI_draw_buffers(GLADloadproc _load) {
	if(!GLAD_GL_ATI_draw_buffers) return;
	glad_glDrawBuffersATI = (PFNGLDRAWBUFFERSATIPROC)load("glDrawBuffersATI");
}
static void load_GL_ATI_element_array(GLADloadproc _load) {
...
static void load_GL_ATI_envmap_bumpmap(GLADloadproc _load) {
...
static void load_GL_ATI_fragment_shader(GLADloadproc _load) {
...
static void load_GL_ATI_map_object_buffer(GLADloadproc _load) {
...
static void load_GL_ATI_pn_triangles(GLADloadproc _load) {
...
static void load_GL_ATI_separate_stencil(GLADloadproc _load) {
...
static void load_GL_ATI_vertex_array_object(GLADloadproc _load) {
...
static void load_GL_ATI_vertex_attrib_array_object(GLADloadproc _load) {
...
static void load_GL_ATI_vertex_streams(GLADloadproc _load) {
...
static void load_GL_EXT_EGL_image_storage(GLADloadproc _load) {
...
static void load_GL_EXT_bindable_uniform(GLADloadproc _load) {
...
static void load_GL_EXT_blend_color(GLADloadproc _load) {
	if(!GLAD_GL_EXT_blend_color) return;
	glad_glBlendColorEXT = (PFNGLBLENDCOLOREXTPROC)load("glBlendColorEXT");
}
static void load_GL_EXT_blend_equation_separate(GLADloadproc _load) {
...
static void load_GL_EXT_blend_func_separate(GLADloadproc _load) {
...
static void load_GL_EXT_blend_minmax(GLADloadproc _load) {
	if(!GLAD_GL_EXT_blend_minmax) return;
	glad_glBlendEquationEXT = (PFNGLBLENDEQUATIONEXTPROC)load("glBlendEquationEXT");
}
static void load_GL_EXT_color_subtable(GLADloadproc _load) {
...
static void load_GL_EXT_compiled_vertex_array(GLADloadproc _load) {
...
static void load_GL_EXT_convolution(GLADloadproc _load) {
...
static void load_GL_EXT_coordinate_frame(GLADloadproc _load) {
...
static void load_GL_EXT_copy_texture(GLADloadproc _load) {
...
static void load_GL_EXT_cull_vertex(GLADloadproc _load) {
...
static void load_GL_EXT_debug_label(GLADloadproc _load) {
...
static void load_GL_EXT_debug_marker(GLADloadproc _load) {
...
static void load_GL_EXT_depth_bounds_test(GLADloadproc _load) {
	if(!GLAD_GL_EXT_depth_bounds_test) return;
	glad_glDepthBoundsEXT = (PFNGLDEPTHBOUNDSEXTPROC)load("glDepthBoundsEXT");
}
static void load_GL_EXT_direct_state_access(GLADloadproc _load) {
...
static void load_GL_EXT_draw_buffers2(GLADloadproc _load) {
...
static void load_GL_EXT_draw_instanced(GLADloadproc _load) {
...
static void load_GL_EXT_draw_range_elements(GLADloadproc _load) {
...
static void load_GL_EXT_external_buffer(GLADloadproc _load) {
...
static void load_GL_EXT_fog_coord(GLADloadproc _load) {
...
static void load_GL_EXT_framebuffer_blit(GLADloadproc _load) {
	if(!GLAD_GL_EXT_framebuffer_blit) return;
	glad_glBlitFramebufferEXT = (PFNGLBLITFRAMEBUFFEREXTPROC)load("glBlitFramebufferEXT");
}
static void load_GL_EXT_framebuffer_multisample(GLADloadproc _load) {
...
static void load_GL_EXT_framebuffer_object(GLADloadproc _load) {
...
static void load_GL_EXT_geometry_shader4(GLADloadproc _load) {
...
static void load_GL_EXT_gpu_program_parameters(GLADloadproc _load) {
...
static void load_GL_EXT_gpu_shader4(GLADloadproc _load) {
...
static void load_GL_EXT_histogram(GLADloadproc _load) {
...
static void load_GL_EXT_memory_object(GLADloadproc _load) {
...
static void load_GL_EXT_memory_object_fd(GLADloadproc _load) {
	if(!GLAD_GL_EXT_memory_object_fd) return;
	glad_glImportMemoryFdEXT = (PFNGLIMPORTMEMORYFDEXTPROC)load("glImportMemoryFdEXT");
}
static void load_GL_EXT_memory_object_win32(GLADloadproc _load) {
...
static void load_GL_EXT_multi_draw_arrays(GLADloadproc _load) {
...
static void load_GL_EXT_multisample(GLADloadproc _load) {
...
static void load_GL_EXT_paletted_texture(GLADloadproc _load) {
...
static void load_GL_EXT_pixel_transform(GLADloadproc _load) {
...
static void load_GL_EXT_point_parameters(GLADloadproc _load) {
...
static void load_GL_EXT_polygon_offset(GLADloadproc _load) {
	if(!GLAD_GL_EXT_polygon_offset) return;
	glad_glPolygonOffsetEXT = (PFNGLPOLYGONOFFSETEXTPROC)load("glPolygonOffsetEXT");
}
static void load_GL_EXT_polygon_offset_clamp(GLADloadproc _load) {
...
static void load_GL_EXT_semaphore(GLADloadproc _load) {
...
static void load_GL_EXT_separate_shader_objects(GLADloadproc _load) {
...
static void load_GL_EXT_shader_framebuffer_fetch_non_coherent(GLADloadproc _load) {
...
static void load_GL_EXT_shader_image_load_store(GLADloadproc _load) {
...
static void load_GL_EXT_stencil_clear_tag(GLADloadproc _load) {
	if(!GLAD_GL_EXT_stencil_clear_tag) return;
	glad_glStencilClearTagEXT = (PFNGLSTENCILCLEARTAGEXTPROC)load("glStencilClearTagEXT");
}
static void load_GL_EXT_stencil_two_side(GLADloadproc _load) {
...
static void load_GL_EXT_subtexture(GLADloadproc _load) {
...
static void load_GL_EXT_texture3D(GLADloadproc _load) {
...
static void load_GL_EXT_texture_array(GLADloadproc _load) {
...
static void load_GL_EXT_texture_buffer_object(GLADloadproc _load) {
	if(!GLAD_GL_EXT_texture_buffer_object) return;
	glad_glTexBufferEXT = (PFNGLTEXBUFFEREXTPROC)load("glTexBufferEXT");
}
static void load_GL_EXT_texture_integer(GLADloadproc _load) {
...
static void load_GL_EXT_texture_object(GLADloadproc _load) {
...
static void load_GL_EXT_texture_perturb_normal(GLADloadproc _load) {
	if(!GLAD_GL_EXT_texture_perturb_normal) return;
	glad_glTextureNormalEXT = (PFNGLTEXTURENORMALEXTPROC)load("glTextureNormalEXT");
}
static void load_GL_EXT_timer_query(GLADloadproc _load) {
...
static void load_GL_EXT_transform_feedback(GLADloadproc _load) {
...
static void load_GL_EXT_vertex_array(GLADloadproc _load) {
...
static void load_GL_EXT_vertex_attrib_64bit(GLADloadproc _load) {
...
static void load_GL_EXT_vertex_shader(GLADloadproc _load) {
...
static void load_GL_EXT_vertex_weighting(GLADloadproc _load) {
...
static void load_GL_EXT_win32_keyed_mutex(GLADloadproc _load) {
...
static void load_GL_EXT_window_rectangles(GLADloadproc _load) {
...
static void load_GL_EXT_x11_sync_object(GLADloadproc _load) {
	if(!GLAD_GL_EXT_x11_sync_object) return;
	glad_glImportSyncEXT = (PFNGLIMPORTSYNCEXTPROC)load("glImportSyncEXT");
}
static void load_GL_GREMEDY_frame_terminator(GLADloadproc _load) {
...
static void load_GL_GREMEDY_string_marker(GLADloadproc _load) {
...
static void load_GL_HP_image_transform(GLADloadproc _load) {
...
static void load_GL_IBM_multimode_draw_arrays(GLADloadproc _load) {
...
static void load_GL_IBM_static_data(GLADloadproc _load) {
	if(!GLAD_GL_IBM_static_data) return;
	glad_glFlushStaticDataIBM = (PFNGLFLUSHSTATICDATAIBMPROC)load("glFlushStaticDataIBM");
}
static void load_GL_IBM_vertex_array_lists(GLADloadproc _load) {
...
static void load_GL_INGR_blend_func_separate(GLADloadproc _load) {
...
static void load_GL_INTEL_framebuffer_CMAA(GLADloadproc _load) {
...
static void load_GL_INTEL_map_texture(GLADloadproc _load) {
...
static void load_GL_INTEL_parallel_arrays(GLADloadproc _load) {
...
static void load_GL_INTEL_performance_query(GLADloadproc _load) {
...
static void load_GL_KHR_parallel_shader_compile(GLADloadproc _load) {
...
static void load_GL_KHR_robustness(GLADloadproc _load) {
...
static void load_GL_NVX_conditional_render(GLADloadproc _load) {
...
static void load_GL_NVX_linked_gpu_multicast(GLADloadproc _load) {
...
static void load_GL_NV_alpha_to_coverage_dither_control(GLADloadproc _load) {
...
static void load_GL_NV_bindless_multi_draw_indirect(GLADloadproc _load) {
...
static void load_GL_NV_bindless_multi_draw_indirect_count(GLADloadproc _load) {
...
static void load_GL_NV_bindless_texture(GLADloadproc _load) {
...
static void load_GL_NV_blend_equation_advanced(GLADloadproc _load) {
...
static void load_GL_NV_clip_space_w_scaling(GLADloadproc _load) {
...
static void load_GL_NV_command_list(GLADloadproc _load) {
...
static void load_GL_NV_conditional_render(GLADloadproc _load) {
...
static void load_GL_NV_conservative_raster(GLADloadproc _load) {
...
static void load_GL_NV_conservative_raster_dilate(GLADloadproc _load) {
...
static void load_GL_NV_conservative_raster_pre_snap_triangles(GLADloadproc _load) {
...
static void load_GL_NV_copy_image(GLADloadproc _load) {
	if(!GLAD_GL_NV_copy_image) return;
	glad_glCopyImageSubDataNV = (PFNGLCOPYIMAGESUBDATANVPROC)load("glCopyImageSubDataNV");
}
static void load_GL_NV_depth_buffer_float(GLADloadproc _load) {
...
static void load_GL_NV_draw_texture(GLADloadproc _load) {
	if(!GLAD_GL_NV_draw_texture) return;
	glad_glDrawTextureNV = (PFNGLDRAWTEXTURENVPROC)load("glDrawTextureNV");
}
static void load_GL_NV_draw_vulkan_image(GLADloadproc _load) {
...
static void load_GL_NV_evaluators(GLADloadproc _load) {
...
static void load_GL_NV_explicit_multisample(GLADloadproc _load) {
...
static void load_GL_NV_fence(GLADloadproc _load) {
...
static void load_GL_NV_fragment_coverage_to_color(GLADloadproc _load) {
...
static void load_GL_NV_fragment_program(GLADloadproc _load) {
...
static void load_GL_NV_framebuffer_mixed_samples(GLADloadproc _load) {
...
static void load_GL_NV_framebuffer_multisample_coverage(GLADloadproc _load) {
...
static void load_GL_NV_geometry_program4(GLADloadproc _load) {
...
static void load_GL_NV_gpu_multicast(GLADloadproc _load) {
...
static void load_GL_NV_gpu_program4(GLADloadproc _load) {
...
static void load_GL_NV_gpu_program5(GLADloadproc _load) {
...
static void load_GL_NV_gpu_shader5(GLADloadproc _load) {
...
static void load_GL_NV_half_float(GLADloadproc _load) {
...
static void load_GL_NV_internalformat_sample_query(GLADloadproc _load) {
...
static void load_GL_NV_memory_attachment(GLADloadproc _load) {
...
static void load_GL_NV_mesh_shader(GLADloadproc _load) {
...
static void load_GL_NV_occlusion_query(GLADloadproc _load) {
...
static void load_GL_NV_parameter_buffer_object(GLADloadproc _load) {
...
static void load_GL_NV_path_rendering(GLADloadproc _load) {
...
static void load_GL_NV_pixel_data_range(GLADloadproc _load) {
...
static void load_GL_NV_point_sprite(GLADloadproc _load) {
...
static void load_GL_NV_present_video(GLADloadproc _load) {
...
static void load_GL_NV_primitive_restart(GLADloadproc _load) {
...
static void load_GL_NV_query_resource(GLADloadproc _load) {
	if(!GLAD_GL_NV_query_resource) return;
	glad_glQueryResourceNV = (PFNGLQUERYRESOURCENVPROC)load("glQueryResourceNV");
}
static void load_GL_NV_query_resource_tag(GLADloadproc _load) {
...
static void load_GL_NV_register_combiners(GLADloadproc _load) {
...
static void load_GL_NV_register_combiners2(GLADloadproc _load) {
...
static void load_GL_NV_sample_locations(GLADloadproc _load) {
...
static void load_GL_NV_scissor_exclusive(GLADloadproc _load) {
...
static void load_GL_NV_shader_buffer_load(GLADloadproc _load) {
...
static void load_GL_NV_shading_rate_image(GLADloadproc _load) {
...
static void load_GL_NV_texture_barrier(GLADloadproc _load) {
	if(!GLAD_GL_NV_texture_barrier) return;
	glad_glTextureBarrierNV = (PFNGLTEXTUREBARRIERNVPROC)load("glTextureBarrierNV");
}
static void load_GL_NV_texture_multisample(GLADloadproc _load) {
...
static void load_GL_NV_transform_feedback(GLADloadproc _load) {
...
static void load_GL_NV_transform_feedback2(GLADloadproc _load) {
...
static void load_GL_NV_vdpau_interop(GLADloadproc _load) {
...
static void load_GL_NV_vdpau_interop2(GLADloadproc _load) {
...
static void load_GL_NV_vertex_array_range(GLADloadproc _load) {
...
static void load_GL_NV_vertex_attrib_integer_64bit(GLADloadproc _load) {
...
static void load_GL_NV_vertex_buffer_unified_memory(GLADloadproc _load) {
...
static void load_GL_NV_vertex_program(GLADloadproc _load) {
...
static void load_GL_NV_vertex_program4(GLADloadproc _load) {
...
static void load_GL_NV_video_capture(GLADloadproc _load) {
...
static void load_GL_NV_viewport_swizzle(GLADloadproc _load) {
	if(!GLAD_GL_NV_viewport_swizzle) return;
	glad_glViewportSwizzleNV = (PFNGLVIEWPORTSWIZZLENVPROC)load("glViewportSwizzleNV");
}
static void load_GL_OES_byte_coordinates(GLADloadproc _load) {
...
static void load_GL_OES_fixed_point(GLADloadproc _load) {
...
static void load_GL_OES_query_matrix(GLADloadproc _load) {
	if(!GLAD_GL_OES_query_matrix) return;
	glad_glQueryMatrixxOES = (PFNGLQUERYMATRIXXOESPROC)load("glQueryMatrixxOES");
}
static void load_GL_OES_single_precision(GLADloadproc _load) {
...
static void load_GL_OVR_multiview(GLADloadproc _load) {
...
static void load_GL_PGI_misc_hints(GLADloadproc _load) {
	if(!GLAD_GL_PGI_misc_hints) return;
	glad_glHintPGI = (PFNGLHINTPGIPROC)load("glHintPGI");
}
static void load_GL_SGIS_detail_texture(GLADloadproc _load) {
...
static void load_GL_SGIS_fog_function(GLADloadproc _load) {
...
static void load_GL_SGIS_multisample(GLADloadproc _load) {
...
static void load_GL_SGIS_pixel_texture(GLADloadproc _load) {
...
static void load_GL_SGIS_point_parameters(GLADloadproc _load) {
...
static void load_GL_SGIS_sharpen_texture(GLADloadproc _load) {
...
static void load_GL_SGIS_texture4D(GLADloadproc _load) {
...
static void load_GL_SGIS_texture_color_mask(GLADloadproc _load) {
...
static void load_GL_SGIS_texture_filter4(GLADloadproc _load) {
...
static void load_GL_SGIX_async(GLADloadproc _load) {
...
static void load_GL_SGIX_flush_raster(GLADloadproc _load) {
	if(!GLAD_GL_SGIX_flush_raster) return;
	glad_glFlushRasterSGIX = (PFNGLFLUSHRASTERSGIXPROC)load("glFlushRasterSGIX");
}
static void load_GL_SGIX_fragment_lighting(GLADloadproc _load) {
...
static void load_GL_SGIX_list_priority(GLADloadproc _load) {
...
static void load_GL_SGIX_pixel_texture(GLADloadproc _load) {
	if(!GLAD_GL_SGIX_pixel_texture) return;
	glad_glPixelTexGenSGIX = (PFNGLPIXELTEXGENSGIXPROC)load("glPixelTexGenSGIX");
}
static void load_GL_SGIX_polynomial_ffd(GLADloadproc _load) {
...
static void load_GL_SGIX_tag_sample_buffer(GLADloadproc _load) {
...
static void load_GL_SGI_color_table(GLADloadproc _load) {
...
static void load_GL_SUNX_constant_data(GLADloadproc _load) {
	if(!GLAD_GL_SUNX_constant_data) return;
	glad_glFinishTextureSUNX = (PFNGLFINISHTEXTURESUNXPROC)load("glFinishTextureSUNX");
}
static void load_GL_SUN_global_alpha(GLADloadproc _load) {
...
static void load_GL_SUN_mesh_array(GLADloadproc _load) {
	if(!GLAD_GL_SUN_mesh_array) return;
	glad_glDrawMeshArraysSUN = (PFNGLDRAWMESHARRAYSSUNPROC)load("glDrawMeshArraysSUN");
}
static void load_GL_SUN_triangle_list(GLADloadproc _load) {
...
static void load_GL_SUN_vertex(GLADloadproc _load) {
...
static int find_extensionsGL(void) {
    ...
    GLAD_GL_ARB_texture_storage_multisample = 1;
#else
...
int gladLoadGLLoader(GLADloadproc _load) {
	GLVersion.major = 0; GLVersion.minor = 0;
	glad_glGetString = (PFNGLGETSTRINGPROC)load("glGetString");
	if(glad_glGetString == NULL) return 0;
	if(glad_glGetString(GL_VERSION) == NULL) return 0;
	find_coreGL();
	load_GL_VERSION_1_0(_load);
	load_GL_VERSION_1_1(_load);
	load_GL_VERSION_1_2(_load);
	load_GL_VERSION_1_3(_load);
	load_GL_VERSION_1_4(_load);
	load_GL_VERSION_1_5(_load);
	load_GL_VERSION_2_0(_load);
	load_GL_VERSION_2_1(_load);
	load_GL_VERSION_3_0(_load);
	load_GL_VERSION_3_1(_load);
	load_GL_VERSION_3_2(_load);
	load_GL_VERSION_3_3(_load);

	if (!find_extensionsGL()) return 0;
	load_GL_3DFX_tbuffer(_load);
	load_GL_AMD_debug_output(_load);
	load_GL_AMD_draw_buffers_blend(_load);
	load_GL_AMD_framebuffer_multisample_advanced(_load);
	load_GL_AMD_framebuffer_sample_positions(_load);
	load_GL_AMD_gpu_shader_int64(_load);
	load_GL_AMD_interleaved_elements(_load);
	load_GL_AMD_multi_draw_indirect(_load);
	load_GL_AMD_name_gen_delete(_load);
	load_GL_AMD_occlusion_query_event(_load);
	load_GL_AMD_performance_monitor(_load);
	load_GL_AMD_sample_positions(_load);
	load_GL_AMD_sparse_texture(_load);
	load_GL_AMD_stencil_operation_extended(_load);
	load_GL_AMD_vertex_shader_tessellator(_load);
	load_GL_APPLE_element_array(_load);
	load_GL_APPLE_fence(_load);
	load_GL_APPLE_flush_buffer_range(_load);
	load_GL_APPLE_object_purgeable(_load);
	load_GL_APPLE_texture_range(_load);
	load_GL_APPLE_vertex_array_object(_load);
	load_GL_APPLE_vertex_array_range(_load);
	load_GL_APPLE_vertex_program_evaluators(_load);
	load_GL_ARB_ES2_compatibility(_load);
	load_GL_ARB_ES3_1_compatibility(_load);
	load_GL_ARB_ES3_2_compatibility(_load);
	load_GL_ARB_base_instance(_load);
	load_GL_ARB_bindless_texture(_load);
	load_GL_ARB_blend_func_extended(_load);
	load_GL_ARB_buffer_storage(_load);
	load_GL_ARB_cl_event(_load);
	load_GL_ARB_clear_buffer_object(_load);
	load_GL_ARB_clear_texture(_load);
	load_GL_ARB_clip_control(_load);
	load_GL_ARB_color_buffer_float(_load);
	load_GL_ARB_compute_shader(_load);
	load_GL_ARB_compute_variable_group_size(_load);
	load_GL_ARB_copy_buffer(_load);
	load_GL_ARB_copy_image(_load);
	load_GL_ARB_debug_output(_load);
	load_GL_ARB_direct_state_access(_load);
	load_GL_ARB_draw_buffers(_load);
	load_GL_ARB_draw_buffers_blend(_load);
	load_GL_ARB_draw_elements_base_vertex(_load);
	load_GL_ARB_draw_indirect(_load);
	load_GL_ARB_draw_instanced(_load);
	load_GL_ARB_fragment_program(_load);
	load_GL_ARB_framebuffer_no_attachments(_load);
	load_GL_ARB_framebuffer_object(_load);
	load_GL_ARB_geometry_shader4(_load);
	load_GL_ARB_get_program_binary(_load);
	load_GL_ARB_get_texture_sub_image(_load);
	load_GL_ARB_gl_spirv(_load);
	load_GL_ARB_gpu_shader_fp64(_load);
	load_GL_ARB_gpu_shader_int64(_load);
	load_GL_ARB_imaging(_load);
	load_GL_ARB_indirect_parameters(_load);
	load_GL_ARB_instanced_arrays(_load);
	load_GL_ARB_internalformat_query(_load);
	load_GL_ARB_internalformat_query2(_load);
	load_GL_ARB_invalidate_subdata(_load);
	load_GL_ARB_map_buffer_range(_load);
	load_GL_ARB_matrix_palette(_load);
	load_GL_ARB_multi_bind(_load);
	load_GL_ARB_multi_draw_indirect(_load);
	load_GL_ARB_multisample(_load);
	load_GL_ARB_multitexture(_load);
	load_GL_ARB_occlusion_query(_load);
	load_GL_ARB_parallel_shader_compile(_load);
	load_GL_ARB_point_parameters(_load);
	load_GL_ARB_polygon_offset_clamp(_load);
	load_GL_ARB_program_interface_query(_load);
	load_GL_ARB_provoking_vertex(_load);
	load_GL_ARB_robustness(_load);
	load_GL_ARB_sample_locations(_load);
	load_GL_ARB_sample_shading(_load);
	load_GL_ARB_sampler_objects(_load);
	load_GL_ARB_separate_shader_objects(_load);
	load_GL_ARB_shader_atomic_counters(_load);
	load_GL_ARB_shader_image_load_store(_load);
	load_GL_ARB_shader_objects(_load);
	load_GL_ARB_shader_storage_buffer_object(_load);
	load_GL_ARB_shader_subroutine(_load);
	load_GL_ARB_shading_language_include(_load);
	load_GL_ARB_sparse_buffer(_load);
	load_GL_ARB_sparse_texture(_load);
	load_GL_ARB_sync(_load);
	load_GL_ARB_tessellation_shader(_load);
	load_GL_ARB_texture_barrier(_load);
	load_GL_ARB_texture_buffer_object(_load);
	load_GL_ARB_texture_buffer_range(_load);
	load_GL_ARB_texture_compression(_load);
	load_GL_ARB_texture_multisample(_load);
	load_GL_ARB_texture_storage(_load);
	load_GL_ARB_texture_storage_multisample(_load);
	load_GL_ARB_texture_view(_load);
	load_GL_ARB_timer_query(_load);
	load_GL_ARB_transform_feedback2(_load);
	load_GL_ARB_transform_feedback3(_load);
	load_GL_ARB_transform_feedback_instanced(_load);
	load_GL_ARB_transpose_matrix(_load);
	load_GL_ARB_uniform_buffer_object(_load);
	load_GL_ARB_vertex_array_object(_load);
	load_GL_ARB_vertex_attrib_64bit(_load);
	load_GL_ARB_vertex_attrib_binding(_load);
	load_GL_ARB_vertex_blend(_load);
	load_GL_ARB_vertex_buffer_object(_load);
	load_GL_ARB_vertex_program(_load);
	load_GL_ARB_vertex_shader(_load);
	load_GL_ARB_vertex_type_2_10_10_10_rev(_load);
	load_GL_ARB_viewport_array(_load);
	load_GL_ARB_window_pos(_load);
	load_GL_ATI_draw_buffers(_load);
	load_GL_ATI_element_array(_load);
	load_GL_ATI_envmap_bumpmap(_load);
	load_GL_ATI_fragment_shader(_load);
	load_GL_ATI_map_object_buffer(_load);
	load_GL_ATI_pn_triangles(_load);
	load_GL_ATI_separate_stencil(_load);
	load_GL_ATI_vertex_array_object(_load);
	load_GL_ATI_vertex_attrib_array_object(_load);
	load_GL_ATI_vertex_streams(_load);
	load_GL_EXT_EGL_image_storage(_load);
	load_GL_EXT_bindable_uniform(_load);
	load_GL_EXT_blend_color(_load);
	load_GL_EXT_blend_equation_separate(_load);
	load_GL_EXT_blend_func_separate(_load);
	load_GL_EXT_blend_minmax(_load);
	load_GL_EXT_color_subtable(_load);
	load_GL_EXT_compiled_vertex_array(_load);
	load_GL_EXT_convolution(_load);
	load_GL_EXT_coordinate_frame(_load);
	load_GL_EXT_copy_texture(_load);
	load_GL_EXT_cull_vertex(_load);
	load_GL_EXT_debug_label(_load);
	load_GL_EXT_debug_marker(_load);
	load_GL_EXT_depth_bounds_test(_load);
	load_GL_EXT_direct_state_access(_load);
	load_GL_EXT_draw_buffers2(_load);
	load_GL_EXT_draw_instanced(_load);
	load_GL_EXT_draw_range_elements(_load);
	load_GL_EXT_external_buffer(_load);
	load_GL_EXT_fog_coord(_load);
	load_GL_EXT_framebuffer_blit(_load);
	load_GL_EXT_framebuffer_multisample(_load);
	load_GL_EXT_framebuffer_object(_load);
	load_GL_EXT_geometry_shader4(_load);
	load_GL_EXT_gpu_program_parameters(_load);
	load_GL_EXT_gpu_shader4(_load);
	load_GL_EXT_histogram(_load);
	load_GL_EXT_index_func(_load);
	load_GL_EXT_index_material(_load);
	load_GL_EXT_light_texture(_load);
	load_GL_EXT_memory_object(_load);
	load_GL_EXT_memory_object_fd(_load);
	load_GL_EXT_memory_object_win32(_load);
	load_GL_EXT_multi_draw_arrays(_load);
	load_GL_EXT_multisample(_load);
	load_GL_EXT_paletted_texture(_load);
	load_GL_EXT_pixel_transform(_load);
	load_GL_EXT_point_parameters(_load);
	load_GL_EXT_polygon_offset(_load);
	load_GL_EXT_polygon_offset_clamp(_load);
	load_GL_EXT_provoking_vertex(_load);
	load_GL_EXT_raster_multisample(_load);
	load_GL_EXT_secondary_color(_load);
	load_GL_EXT_semaphore(_load);
	load_GL_EXT_semaphore_fd(_load);
	load_GL_EXT_semaphore_win32(_load);
	load_GL_EXT_separate_shader_objects(_load);
	load_GL_EXT_shader_framebuffer_fetch_non_coherent(_load);
	load_GL_EXT_shader_image_load_store(_load);
	load_GL_EXT_stencil_clear_tag(_load);
	load_GL_EXT_stencil_two_side(_load);
	load_GL_EXT_subtexture(_load);
	load_GL_EXT_texture3D(_load);
	load_GL_EXT_texture_array(_load);
	load_GL_EXT_texture_buffer_object(_load);
	load_GL_EXT_texture_integer(_load);
	load_GL_EXT_texture_object(_load);
	load_GL_EXT_texture_perturb_normal(_load);
	load_GL_EXT_timer_query(_load);
	load_GL_EXT_transform_feedback(_load);
	load_GL_EXT_vertex_array(_load);
	load_GL_EXT_vertex_attrib_64bit(_load);
	load_GL_EXT_vertex_shader(_load);
	load_GL_EXT_vertex_weighting(_load);
	load_GL_EXT_win32_keyed_mutex(_load);
	load_GL_EXT_window_rectangles(_load);
	load_GL_EXT_x11_sync_object(_load);
	load_GL_GREMEDY_frame_terminator(_load);
	load_GL_GREMEDY_string_marker(_load);
	load_GL_HP_image_transform(_load);
	load_GL_IBM_multimode_draw_arrays(_load);
	load_GL_IBM_static_data(_load);
	load_GL_IBM_vertex_array_lists(_load);
	load_GL_INGR_blend_func_separate(_load);
	load_GL_INTEL_framebuffer_CMAA(_load);
	load_GL_INTEL_map_texture(_load);
	load_GL_INTEL_parallel_arrays(_load);
	load_GL_INTEL_performance_query(_load);
	load_GL_KHR_blend_equation_advanced(_load);
	load_GL_KHR_debug(_load);
	load_GL_KHR_parallel_shader_compile(_load);
	load_GL_KHR_robustness(_load);
	load_GL_MESA_resize_buffers(_load);
	load_GL_MESA_window_pos(_load);
	load_GL_NVX_conditional_render(_load);
	load_GL_NVX_linked_gpu_multicast(_load);
	load_GL_NV_alpha_to_coverage_dither_control(_load);
	load_GL_NV_bindless_multi_draw_indirect(_load);
	load_GL_NV_bindless_multi_draw_indirect_count(_load);
	load_GL_NV_bindless_texture(_load);
	load_GL_NV_blend_equation_advanced(_load);
	load_GL_NV_clip_space_w_scaling(_load);
	load_GL_NV_command_list(_load);
	load_GL_NV_conditional_render(_load);
	load_GL_NV_conservative_raster(_load);
	load_GL_NV_conservative_raster_dilate(_load);
	load_GL_NV_conservative_raster_pre_snap_triangles(_load);
	load_GL_NV_copy_image(_load);
	load_GL_NV_depth_buffer_float(_load);
	load_GL_NV_draw_texture(_load);
	load_GL_NV_draw_vulkan_image(_load);
	load_GL_NV_evaluators(_load);
	load_GL_NV_explicit_multisample(_load);
	load_GL_NV_fence(_load);
	load_GL_NV_fragment_coverage_to_color(_load);
	load_GL_NV_fragment_program(_load);
	load_GL_NV_framebuffer_mixed_samples(_load);
	load_GL_NV_framebuffer_multisample_coverage(_load);
	load_GL_NV_geometry_program4(_load);
	load_GL_NV_gpu_multicast(_load);
	load_GL_NV_gpu_program4(_load);
	load_GL_NV_gpu_program5(_load);
	load_GL_NV_gpu_shader5(_load);
	load_GL_NV_half_float(_load);
	load_GL_NV_internalformat_sample_query(_load);
	load_GL_NV_memory_attachment(_load);
	load_GL_NV_mesh_shader(_load);
	load_GL_NV_occlusion_query(_load);
	load_GL_NV_parameter_buffer_object(_load);
	load_GL_NV_path_rendering(_load);
	load_GL_NV_pixel_data_range(_load);
	load_GL_NV_point_sprite(_load);
	load_GL_NV_present_video(_load);
	load_GL_NV_primitive_restart(_load);
	load_GL_NV_query_resource(_load);
	load_GL_NV_query_resource_tag(_load);
	load_GL_NV_register_combiners(_load);
	load_GL_NV_register_combiners2(_load);
	load_GL_NV_sample_locations(_load);
	load_GL_NV_scissor_exclusive(_load);
	load_GL_NV_shader_buffer_load(_load);
	load_GL_NV_shading_rate_image(_load);
	load_GL_NV_texture_barrier(_load);
	load_GL_NV_texture_multisample(_load);
	load_GL_NV_transform_feedback(_load);
	load_GL_NV_transform_feedback2(_load);
	load_GL_NV_vdpau_interop(_load);
	load_GL_NV_vdpau_interop2(_load);
	load_GL_NV_vertex_array_range(_load);
	load_GL_NV_vertex_attrib_integer_64bit(_load);
	load_GL_NV_vertex_buffer_unified_memory(_load);
	load_GL_NV_vertex_program(_load);
	load_GL_NV_vertex_program4(_load);
	load_GL_NV_video_capture(_load);
	load_GL_NV_viewport_swizzle(_load);
	load_GL_OES_byte_coordinates(_load);
	load_GL_OES_fixed_point(_load);
	load_GL_OES_query_matrix(_load);
	load_GL_OES_single_precision(_load);
	load_GL_OVR_multiview(_load);
	load_GL_PGI_misc_hints(_load);
	load_GL_SGIS_detail_texture(_load);
	load_GL_SGIS_fog_function(_load);
	load_GL_SGIS_multisample(_load);
	load_GL_SGIS_pixel_texture(_load);
	load_GL_SGIS_point_parameters(_load);
	load_GL_SGIS_sharpen_texture(_load);
	load_GL_SGIS_texture4D(_load);
	load_GL_SGIS_texture_color_mask(_load);
	load_GL_SGIS_texture_filter4(_load);
	load_GL_SGIX_async(_load);
	load_GL_SGIX_flush_raster(_load);
	load_GL_SGIX_fragment_lighting(_load);
	load_GL_SGIX_framezoom(_load);
	load_GL_SGIX_igloo_interface(_load);
	load_GL_SGIX_instruments(_load);
	load_GL_SGIX_list_priority(_load);
	load_GL_SGIX_pixel_texture(_load);
	load_GL_SGIX_polynomial_ffd(_load);
	load_GL_SGIX_reference_plane(_load);
	load_GL_SGIX_sprite(_load);
	load_GL_SGIX_tag_sample_buffer(_load);
	load_GL_SGI_color_table(_load);
	load_GL_SUNX_constant_data(_load);
	load_GL_SUN_global_alpha(_load);
	load_GL_SUN_mesh_array(_load);
	load_GL_SUN_triangle_list(_load);
	load_GL_SUN_vertex(_load);
