...
#define PLAYER_ANIM_DEATH_BACK 20
#define PLAYER_ANIM_DEATH_EASYFALLBACK 21
#define PLAYER_ANIM_DEATH_FORWARD 22
#define PLAYER_ANIM_DEATH_EASYFALLFORWARD 23
#define PLAYER_ANIM_DEATH_SPIKES 24
#define PLAYER_ANIM_STATUE_PUT 25
