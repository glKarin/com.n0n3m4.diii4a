...
EP_ENUMBEG(BasicEffectType)
  EP_ENUMVALUE(BET_NONE, ""),
  EP_ENUMVALUE(BET_ROCKET, ""),
  EP_ENUMVALUE(BET_ROCKET_PLANE, ""),
  EP_ENUMVALUE(BET_GRENADE, ""),
  EP_ENUMVALUE(BET_GRENADE_PLANE, ""),
  EP_ENUMVALUE(BET_EXPLOSIONSTAIN, ""),
  EP_ENUMVALUE(BET_SHOCKWAVE, ""),
  EP_ENUMVALUE(BET_LASERWAVE, ""),
  EP_ENUMVALUE(BET_BLOODSPILL, ""),
  EP_ENUMVALUE(BET_BLOODSTAIN, ""),
  EP_ENUMVALUE(BET_BLOODSTAINGROW, ""),
  EP_ENUMVALUE(BET_BLOODEXPLODE, ""),
  EP_ENUMVALUE(BET_CANNON, ""),
  EP_ENUMVALUE(BET_CANNON_PLANE, ""),
  EP_ENUMVALUE(BET_CANNONEXPLOSIONSTAIN, ""),
  EP_ENUMVALUE(BET_CANNONSHOCKWAVE, ""),
  EP_ENUMVALUE(BET_TELEPORT, ""),
  EP_ENUMVALUE(BET_BOMB, ""),
  EP_ENUMVALUE(BET_BULLETTRAIL, ""),
  EP_ENUMVALUE(BET_GIZMO_SPLASH_FX, ""),
  EP_ENUMVALUE(BET_GIZMOSTAIN, ""),
  EP_ENUMVALUE(BET_BULLETSTAINSTONE, ""),
  EP_ENUMVALUE(BET_BULLETSTAINSAND, ""),
  EP_ENUMVALUE(BET_BULLETSTAINWATER, ""),
  EP_ENUMVALUE(BET_BULLETSTAINUNDERWATER, ""),
  EP_ENUMVALUE(BET_BULLETSTAINSTONENOSOUND, ""),
  EP_ENUMVALUE(BET_BULLETSTAINSANDNOSOUND, ""),
  EP_ENUMVALUE(BET_BULLETSTAINWATERNOSOUND, ""),
  EP_ENUMVALUE(BET_BULLETSTAINUNDERWATERNOSOUND, ""),
  EP_ENUMVALUE(BET_BULLETSTAINREDSAND, ""),
  EP_ENUMVALUE(BET_BULLETSTAINREDSANDNOSOUND, ""),
  EP_ENUMVALUE(BET_LIGHT_CANNON, ""),
  EP_ENUMVALUE(BET_CANNON_NOLIGHT, ""),
