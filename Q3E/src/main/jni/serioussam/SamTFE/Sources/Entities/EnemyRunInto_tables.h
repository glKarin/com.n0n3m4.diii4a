...
CEntityProperty CEnemyRunInto_properties[] = {
 ...
 CEntityProperty(CEntityProperty::EPT_ANGLE, NULL, (0x00000138<<8)+10, _offsetof(CEnemyRunInto, m_fAttackRotateRunInto), "", 0, 0, 0),
};
...
RunAwayFromEnemy),DEBUGSTRING("CEnemyRunInto::RunAwayFromEnemy")},
 ...
 {0x0138000e, STATE_CEnemyBase_MainLoop, CEntity::pEventHandler(&CEnemyRunInto::
