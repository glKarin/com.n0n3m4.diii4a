...
CEntityProperty CDamager_properties[] = {
 ...
 CEntityProperty(CEntityProperty::EPT_ENTITYPTR, NULL, (0x000000e5<<8)+10, _offsetof(CDamager, m_penLastDamaged), "", 0, 0, 0),
 CEntityProperty(CEntityProperty::EPT_FLOAT, NULL, (0x000000e5<<8)+11, _offsetof(CDamager, m_tmLastDamage), "", 0, 0, 0),
};
