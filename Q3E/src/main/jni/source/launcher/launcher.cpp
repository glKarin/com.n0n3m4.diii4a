...
#endif
#ifdef _DIII4A //karin: engine pipeline function
extern bool q3e_initialized;
extern void Q3E_SetupEngineInteraction(HMODULE handle);
#endif
...
#ifdef _DIII4A //karin: get dll handle
	HMODULE handle = GetModuleHandle("engine" DLL_EXT_STRING);
	Q3E_SetupEngineInteraction(handle);
#endif
