...
#ifdef _DIII4A //karin: Q3E hack
#include "client_main.inc"
#endif
...
#ifdef _DIII4A
		Q3E_AnalogForwardMove2(cmd->sidemove, ideal_sin, ideal_cos);
#endif
...
#ifdef _DIII4A
	Q3E_AnalogSideMove3(cmd->sidemove);
#endif
}
...
void CInput::ComputeForwardMove( CUserCmd *cmd )
{
...
#ifdef _DIII4A
		Q3E_AnalogForwardMove1(cmd->forwardmove);
#endif
	...
	if ( CAM_IsThirdPerson() && thirdperson_screenspace.GetInt() )
	{
		...
		cmd->forwardmove += cl_forwardspeed.GetFloat() * movement;
#ifdef _DIII4A
		Q3E_AnalogForwardMove2(cmd->forwardmove, ideal_sin, ideal_cos);
#endif
...
#ifdef _DIII4A
	Q3E_AnalogForwardMove3(cmd->forwardmove);
#endif
}
...
#ifdef _DIII4A //karin: analog move on ladder
	Q3E_AnalogMoveButtonBit(bits, bResetState);
#endif
