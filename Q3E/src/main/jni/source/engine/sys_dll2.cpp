...
#ifdef _DIII4A //karin: Q3E interactive
...
bool CEngineAPI::MainLoop()
{
	...
	while ( true )
	{
#ifdef _DIII4A //karin: Q3E loop hack
		if(!Q3E_Engine_IsRunning())
        {
            StopGProfiler();
            return true;
        }
...
#ifdef _DIII4A //karin: Q3E loop hack
		Q3E_Engine_CheckGLInitialized();
		Q3E_Engine_PullEvents();
		Q3E_Engine_AnalogEvent();
		Q3E_Engine_SyncState();
#endif
