...
ID_INLINE float __fmuls(float a, float b) { return (a * b); }
ID_INLINE float __fmadds(float a, float b, float c) { return (a * b + c); }
ID_INLINE float __fnmsubs(float a, float b, float c) { return (c - a * b); }
ID_INLINE float __fsels(float a, float b, float c) { return (a >= 0.0f) ? b : c; }
ID_INLINE float __frcps(float x) { return (1.0f / x); }
ID_INLINE float __fdivs(float x, float y) { return (x / y); }
ID_INLINE float __frsqrts(float x) { return (1.0f / sqrtf(x)); }
ID_INLINE float __frcps16(float x) { return (1.0f / x); }
ID_INLINE float __fdivs16(float x, float y) { return (x / y); }
ID_INLINE float __frsqrts16(float x) { return (1.0f / sqrtf(x)); }
ID_INLINE float __frndz(float x) { return (float)((int)(x)); }
