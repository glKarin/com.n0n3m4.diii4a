...
public:
	...
	void				SetColor4(float r, float g, float b, float a) { SetColor(idVec4(r, g, b, a)); }
	void				SetColor(const idVec4& rgba) { SetColorLocal(rgba.x, rgba.y, rgba.z, rgba.w); currentColor = rgba; }
	idVec4				GetColor(void) { return currentColor; } 
...
protected:
	...
	void	 			SetColorLocal(float r, float g, float b, float a);
...
extern idDeviceContextOptimized*				deviceContext;
