...
// jmarshall
	bool					IsDukeVoice(void) const { return parms.isDukeVoice; }
// jmarshall end
...
// jmarshall
static const int SCHANNEL_MUSIC = 7;
static const int SCHANNEL_DUKETALK = 6;
// jmarshall end
...
// jmarshall
	virtual int				PlayShaderDirectly(const idSoundShader* shader, int channel = -1) = 0;
// jmarshall end
