...
//karin: #ifdef __cpp_lib_hardware_interference_size
#if defined(__cpp_lib_hardware_interference_size) && !defined(_DIII4A) //karin: require C++17 standard, but NDK23 not support
