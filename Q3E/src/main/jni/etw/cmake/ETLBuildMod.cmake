...
if(BUILD_SERVER_MOD)
	...
	if(FEATURE_LUASQL AND FEATURE_DBMS)
		...
		if(BUNDLED_SQLITE3)
			target_link_libraries(qagame ${SQLITE3_LIBRARY} #[[bundled_sqlite3]])
...
if(BUILD_SERVER_MOD)
	...
	if(FEATURE_LUASQL AND FEATURE_DBMS)
		...
		if(BUNDLED_SQLITE3)
			target_link_libraries(tvgame ${SQLITE3_LIBRARY} #[[bundled_sqlite3]])
		else() # BUNDLED_SQLITE3
			find_package(SQLite3 REQUIRED)
