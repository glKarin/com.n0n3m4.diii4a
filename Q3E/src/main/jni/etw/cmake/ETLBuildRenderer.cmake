...
if(FEATURE_RENDERER2)
	...
	add_custom_command(
		...
		COMMAND shdr2h LEGACY ${CMAKE_CURRENT_SOURCE_DIR}/src/renderer2/glsl ${CMAKE_CURRENT_SOURCE_DIR}/src/renderer2/gldef/default.gldef ${CMAKE_CURRENT_BINARY_DIR}/include/shaders.h
		DEPENDS shdr2h
