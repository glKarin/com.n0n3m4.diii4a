...
if(ETL_BUILD_DATE AND ETL_BUILD_TIME)
	string(TIMESTAMP ETL_CMAKE_BUILD_TIME "${ETL_BUILD_DATE}T${ETL_BUILD_TIME}" UTC)
	string(TIMESTAMP ETL_CMAKE_BUILD_DATE "${ETL_BUILD_DATE}" UTC)
else()
