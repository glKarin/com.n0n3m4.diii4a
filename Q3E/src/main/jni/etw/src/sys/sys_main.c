...
dialogResult_t Sys_SDLDialog(dialogType_t type, const char *message, const char *title)
{
    ...
    switch (type)
    {
        ...
        case DT_INFO:
            buttons[0] = _("Ok");
            res = Android_OpenDialog(title, message, 1, buttons);
            break;
        case DT_WARNING:
            buttons[0] = _("Ok");
            res = Android_OpenDialog(title, message, 1, buttons);
...
#if !defined(_DIII4A) //karin: unuse SDL on Android
#ifndef DEDICATED
	SDL_Quit();
#endif
#endif
...
#define Sys_GetDLLName_DIII4A(x) "libetw" x DLL_EXT
	if(_load_dll_name)
	{
		...
		Com_sprintf(dllName, sizeof(dllName), Sys_GetDLLName_DIII4A("%s"), _load_dll_name);
		char realLibName[MAX_OSPATH];
		extern char * Sys_MakeDLLPath(const char *libname, char path[], int max_length);
		Sys_MakeDLLPath(dllName, realLibName, MAX_OSPATH);
...
void Sys_ParseArgsDrawBanner(FILE *stream)
{
	...
	if (!alreadyDrawn)
	{
		...
		fprintf(stream,
		        "  ¨€¨€¨€¨€¨€¨€¨€¨[¨€¨€¨€¨€¨€¨€¨€¨€¨[   ¨€¨€¨[     ¨€¨€¨€¨€¨€¨€¨€¨[ ¨€¨€¨€¨€¨€¨€¨[  ¨€¨€¨€¨€¨€¨[  ¨€¨€¨€¨€¨€¨€¨[¨€¨€¨[   ¨€¨€¨[\n"
		        "  ¨€¨€¨X¨T¨T¨T¨T¨a¨^¨T¨T¨€¨€¨X¨T¨T¨a¨€¨€¨[¨€¨€¨U     ¨€¨€¨X¨T¨T¨T¨T¨a¨€¨€¨X¨T¨T¨T¨T¨a ¨€¨€¨X¨T¨T¨€¨€¨[¨€¨€¨X¨T¨T¨T¨T¨a¨^¨€¨€¨[ ¨€¨€¨X¨a\n"
		        "  ¨€¨€¨€¨€¨€¨[     ¨€¨€¨U   ¨^¨T¨a¨€¨€¨U     ¨€¨€¨€¨€¨€¨[  ¨€¨€¨U  ¨€¨€¨€¨[¨€¨€¨€¨€¨€¨€¨€¨U¨€¨€¨U      ¨^¨€¨€¨€¨€¨X¨a\n"
		        "  ¨€¨€¨X¨T¨T¨a     ¨€¨€¨U   ¨€¨€¨[¨€¨€¨U     ¨€¨€¨X¨T¨T¨a  ¨€¨€¨U   ¨€¨€¨U¨€¨€¨X¨T¨T¨€¨€¨U¨€¨€¨U       ¨^¨€¨€¨X¨a\n"
		        "  ¨€¨€¨€¨€¨€¨€¨€¨[   ¨€¨€¨U   ¨^¨T¨a¨€¨€¨€¨€¨€¨€¨€¨[¨€¨€¨€¨€¨€¨€¨€¨[¨^¨€¨€¨€¨€¨€¨€¨X¨a¨€¨€¨U  ¨€¨€¨U¨^¨€¨€¨€¨€¨€¨€¨[   ¨€¨€¨U\n"
		        "  ¨^¨T¨T¨T¨T¨T¨T¨a   ¨^¨T¨a      ¨^¨T¨T¨T¨T¨T¨T¨a¨^¨T¨T¨T¨T¨T¨T¨a ¨^¨T¨T¨T¨T¨T¨a ¨^¨T¨a  ¨^¨T¨a ¨^¨T¨T¨T¨T¨T¨a   ¨^¨T¨a\n"
#ifdef DEDICATED
		        "    Dedicated Server\n"
#endif
		        "    Version: %s\n"
...
#ifdef _DIII4A //karin: include generic Q3E functions
...
#if !defined(_DIII4A) //karin: main function in ../android/sys_android.c on Android
/**
 * @brief SDL_main
 * @param[in] argc
 * @param[in] argv
