...
bool WaypointSerializer_V1::Load(File &_file, PathPlannerWaypoint::WaypointList &_wpl)
{
...
bool WaypointSerializer_V1::Save(File &_file, PathPlannerWaypoint::WaypointList &_wpl)
{
