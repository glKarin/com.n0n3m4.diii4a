...
static int GM_CDECL gmFileOpGetDot(gmThread * a_thread, gmVariable * a_operands)
{
...
static int GM_CDECL gmFileFindOpGetDot(gmThread * a_thread, gmVariable * a_operands)
{
	gmUserObject * user = (gmUserObject *) GM_OBJECT(a_operands->m_value.m_ref);
	if(user && user->m_user)
	{
...
static int GM_CDECL gmFileInfoOpGetDot(gmThread * a_thread, gmVariable * a_operands)
{
	gmUserObject * user = (gmUserObject *) GM_OBJECT(a_operands->m_value.m_ref);
	if(user && user->m_user)
	{
