...
extern void gmDebuggerRun(gmDebuggerSession * a_session, int a_threadId, int a_LineNo, const char *a_FuncName, const char *a_File);
...
extern void gmDebuggerContextCallFrame(gmDebuggerSession * a_session, int a_callFrame, const char * a_functionName, int a_sourceId, int a_lineNumber, const char * a_thisSymbol, const char * a_thisValue, int a_thisType, int a_thisId);
extern void gmDebuggerContextVariable(gmDebuggerSession * a_session, const char * a_varSymbol, const char * a_varValue, int a_varType, int a_varId);
...
extern void gmDebuggerBeginGlobals(gmDebuggerSession * a_session, int a_VarId);
extern void gmDebuggerGlobal(gmDebuggerSession * a_session, const char * a_varSymbol, const char * a_varValue, int a_varType, int a_VarId);
extern void gmDebuggerEndGlobals(gmDebuggerSession * a_session);
...
void gmMachineGetGlobalsInfo(gmDebuggerSession * a_session, int a_tableRef);
...
void gmMachineBreakAll(gmDebuggerSession * a_session);
void gmMachineKill(gmDebuggerSession * a_session, int a_threadId);
void gmMachineKillAll(gmDebuggerSession * a_session);
void gmMachineQuit(gmDebuggerSession * a_session);
void gmMachineRunScript(gmDebuggerSession * a_session, const char *_script);
