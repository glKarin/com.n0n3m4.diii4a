...
////////////////////////////////////////////////////////////
WindowImplWin32::WindowImplWin32(WindowHandle Handle, WindowSettings& Params, bool UseCurrentWindow) :
myHandle          (NULL),
myCallback        (0),
myCursor          (NULL),
myIcon            (NULL),
...
myGLContext			(NULL)
{
    ...
    if (myHandle)
    {
        ...
        CreateContext(Mode, Params, UseCurrentWindow);
...
myGLContext			(NULL)
{
    ...
    // Create the rendering context
    if (myHandle)
        CreateContext(Mode, Params, false);
...
////////////////////////////////////////////////////////////
void WindowImplWin32::CreateContext(const VideoMode& Mode, WindowSettings& Params, bool UseCurrentWindow)
{
...
Key::Code WindowImplWin32::VirtualKeyCodeToSF(WPARAM VirtualKey, LPARAM Flags)
{
    switch (VirtualKey)
    {
		...
		// custom
		case VK_CAPITAL:	return Key::PrintScreen;
