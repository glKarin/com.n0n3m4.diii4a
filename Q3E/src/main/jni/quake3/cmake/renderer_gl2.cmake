...
set(SHADERS_DIR ${IOQ3_BINARY_DIR}/shaders.dir)
...
foreach(SHADER_FILE IN LISTS RENDERER_GL2_SHADER_SOURCES)
    ...
    string(REPLACE "${IOQ3_BINARY_DIR}/" "" SHADER_C_FILE_COMMENT ${SHADER_C_FILE})
    ...
    add_custom_command(
        ...
        COMMAND ${CMAKE_COMMAND}
            ...
            -P ${IOQ3_SOURCE_DIR}/cmake/utils/stringify_shader.cmake
        DEPENDS ${SHADER_FILE}
