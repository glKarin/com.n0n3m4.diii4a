...
set(TOOLS_DIR ${IOQ3_BINARY_DIR}/tools)
...
ExternalProject_Add(qvm_tools
    SOURCE_DIR ${IOQ3_SOURCE_DIR}/cmake/tools
...
function(add_qvm MODULE_NAME)
    ...
    set(QVM_OUTPUT_DIR ${IOQ3_BINARY_DIR}/$<CONFIG>)
    ...
    set(QVM_ASM_DIR ${IOQ3_BINARY_DIR}/qvm.dir/${MODULE_NAME})
    ...
    foreach(SOURCE ${ARG_SOURCES})
        ...
        string(REPLACE "${IOQ3_BINARY_DIR}/" "" ASM_FILE_COMMENT ${ASM_FILE})
    ...
    string(REPLACE "${IOQ3_BINARY_DIR}/" "" QVM_FILE_COMMENT ${QVM_FILE})
    add_custom_command(
        OUTPUT ${QVM_FILE}
