...
function(finish_macos_app)
    ...
    configure_file(${IOQ3_SOURCE_DIR}/cmake/Info.plist.in
        ${IOQ3_BINARY_DIR}/Info.plist @ONLY)

    set_target_properties(${CLIENT_BINARY} PROPERTIES
        MACOSX_BUNDLE_INFO_PLIST ${IOQ3_BINARY_DIR}/Info.plist)
...
if(NOT "$ENV{APPLE_CERTIFICATE_ID}" STREQUAL "")
    ...
    function(codesign)
        ...
        get_directory_property(INSTALL_TARGETS DIRECTORY
            ${IOQ3_SOURCE_DIR} BUILDSYSTEM_TARGETS)
...
set(CPACK_DMG_BACKGROUND_IMAGE "${IOQ3_SOURCE_DIR}/misc/macos-dmg-background.png")
set(CPACK_DMG_SUBDIRECTORY "${CLIENT_NAME}")

configure_file(
  "${IOQ3_SOURCE_DIR}/misc/macos-dmg-setup.applescript.in"
  "${IOQ3_BINARY_DIR}/macos-dmg-setup.applescript"
  @ONLY
)

set(CPACK_DMG_DS_STORE_SETUP_SCRIPT "${IOQ3_BINARY_DIR}/macos-dmg-setup.applescript")
