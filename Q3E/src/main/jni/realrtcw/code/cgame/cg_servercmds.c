...
static void CG_MapRestart( void ) {
	...
	cg.buyPrintTime = 0; // reset centerprint counter so previous messages don't re-appear
	cg.egPrintTime = 0; // reset centerprint counter so previous messages don't re-appear
