...
JNIEXPORT jboolean JNICALL Java_com_n0n3m4_q3e_Q3EJNI_init
  (JNIEnv *, jclass, jstring, jstring, jint, jint, jstring, jstring, jstring, jobject, jint, jint, jint, jboolean, jint, jboolean, jboolean, jint, jstring, jboolean, jint, jboolean);
