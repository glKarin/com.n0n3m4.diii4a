...
{
	return skin ? idStr(fileName) + idStr('\1') + idStr(skin->GetName()) : idStr(fileName); // grayman - make linux compiler happy
...
void idCollisionModelManagerLocal::PrintModelInfo( const cm_model_t *model ) {
	common->Printf( "%6i vertices (%lli KB)\n", model->numVertices, int64(model->numVertices * sizeof(cm_vertex_t))>>10 );
	common->Printf( "%6i edges (%lli KB)\n", model->numEdges, int64(model->numEdges * sizeof(cm_edge_t))>>10 );
	...
	common->Printf( "%6i nodes (%lli KB)\n", model->numNodes, int64(model->numNodes * sizeof(cm_node_t))>>10 );
	common->Printf( "%6i polygon refs (%lli KB)\n", model->numPolygonRefs, int64(model->numPolygonRefs * sizeof(cm_polygonRef_t))>>10 );
	common->Printf( "%6i brush refs (%lli KB)\n", model->numBrushRefs, int64(model->numBrushRefs * sizeof(cm_brushRef_t))>>10 );
