/*
    ...
    WGL loader generated by glad 0.1.29 on -.
...
#if defined(GLAD_COMPILE_LOADER) || WGL_VERSION_1_0
GLAPI int GLAD_WGL_VERSION_1_0;
typedef int (APIENTRYP PFNCHOOSEPIXELFORMATPROC)(HDC hDc, const PIXELFORMATDESCRIPTOR *pPfd);
GLAPI PFNCHOOSEPIXELFORMATPROC glad_ChoosePixelFormat;
#define qChoosePixelFormat glad_ChoosePixelFormat
typedef int (APIENTRYP PFNDESCRIBEPIXELFORMATPROC)(HDC hdc, int ipfd, UINT cjpfd, const PIXELFORMATDESCRIPTOR *ppfd);
GLAPI PFNDESCRIBEPIXELFORMATPROC glad_DescribePixelFormat;
#define qDescribePixelFormat glad_DescribePixelFormat
typedef UINT (APIENTRYP PFNGETENHMETAFILEPIXELFORMATPROC)(HENHMETAFILE hemf, const PIXELFORMATDESCRIPTOR *ppfd);
GLAPI PFNGETENHMETAFILEPIXELFORMATPROC glad_GetEnhMetaFilePixelFormat;
#define qGetEnhMetaFilePixelFormat glad_GetEnhMetaFilePixelFormat
typedef int (APIENTRYP PFNGETPIXELFORMATPROC)(HDC hdc);
GLAPI PFNGETPIXELFORMATPROC glad_GetPixelFormat;
#define qGetPixelFormat glad_GetPixelFormat
typedef BOOL (APIENTRYP PFNSETPIXELFORMATPROC)(HDC hdc, int ipfd, const PIXELFORMATDESCRIPTOR *ppfd);
GLAPI PFNSETPIXELFORMATPROC glad_SetPixelFormat;
#define qSetPixelFormat glad_SetPixelFormat
typedef BOOL (APIENTRYP PFNSWAPBUFFERSPROC)(HDC hdc);
GLAPI PFNSWAPBUFFERSPROC glad_SwapBuffers;
#define qSwapBuffers glad_SwapBuffers
typedef BOOL (APIENTRYP PFNWGLCOPYCONTEXTPROC)(HGLRC hglrcSrc, HGLRC hglrcDst, UINT mask);
GLAPI PFNWGLCOPYCONTEXTPROC glad_wglCopyContext;
#define qwglCopyContext glad_wglCopyContext
typedef HGLRC (APIENTRYP PFNWGLCREATECONTEXTPROC)(HDC hDc);
GLAPI PFNWGLCREATECONTEXTPROC glad_wglCreateContext;
#define qwglCreateContext glad_wglCreateContext
typedef HGLRC (APIENTRYP PFNWGLCREATELAYERCONTEXTPROC)(HDC hDc, int level);
GLAPI PFNWGLCREATELAYERCONTEXTPROC glad_wglCreateLayerContext;
#define qwglCreateLayerContext glad_wglCreateLayerContext
typedef BOOL (APIENTRYP PFNWGLDELETECONTEXTPROC)(HGLRC oldContext);
GLAPI PFNWGLDELETECONTEXTPROC glad_wglDeleteContext;
#define qwglDeleteContext glad_wglDeleteContext
...
GLAPI PFNWGLDESCRIBELAYERPLANEPROC glad_wglDescribeLayerPlane;
#define qwglDescribeLayerPlane glad_wglDescribeLayerPlane
typedef HGLRC (APIENTRYP PFNWGLGETCURRENTCONTEXTPROC)(void);
GLAPI PFNWGLGETCURRENTCONTEXTPROC glad_wglGetCurrentContext;
#define qwglGetCurrentContext glad_wglGetCurrentContext
typedef HDC (APIENTRYP PFNWGLGETCURRENTDCPROC)(void);
GLAPI PFNWGLGETCURRENTDCPROC glad_wglGetCurrentDC;
#define qwglGetCurrentDC glad_wglGetCurrentDC
...
GLAPI PFNWGLGETLAYERPALETTEENTRIESPROC glad_wglGetLayerPaletteEntries;
#define qwglGetLayerPaletteEntries glad_wglGetLayerPaletteEntries
typedef PROC (APIENTRYP PFNWGLGETPROCADDRESSPROC)(LPCSTR lpszProc);
GLAPI PFNWGLGETPROCADDRESSPROC glad_wglGetProcAddress;
#define qwglGetProcAddress glad_wglGetProcAddress
typedef BOOL (APIENTRYP PFNWGLMAKECURRENTPROC)(HDC hDc, HGLRC newContext);
GLAPI PFNWGLMAKECURRENTPROC glad_wglMakeCurrent;
#define qwglMakeCurrent glad_wglMakeCurrent
typedef BOOL (APIENTRYP PFNWGLREALIZELAYERPALETTEPROC)(HDC hdc, int iLayerPlane, BOOL bRealize);
GLAPI PFNWGLREALIZELAYERPALETTEPROC glad_wglRealizeLayerPalette;
#define qwglRealizeLayerPalette glad_wglRealizeLayerPalette
...
GLAPI PFNWGLSETLAYERPALETTEENTRIESPROC glad_wglSetLayerPaletteEntries;
#define qwglSetLayerPaletteEntries glad_wglSetLayerPaletteEntries
typedef BOOL (APIENTRYP PFNWGLSHARELISTSPROC)(HGLRC hrcSrvShare, HGLRC hrcSrvSource);
GLAPI PFNWGLSHARELISTSPROC glad_wglShareLists;
#define qwglShareLists glad_wglShareLists
typedef BOOL (APIENTRYP PFNWGLSWAPLAYERBUFFERSPROC)(HDC hdc, UINT fuFlags);
GLAPI PFNWGLSWAPLAYERBUFFERSPROC glad_wglSwapLayerBuffers;
#define qwglSwapLayerBuffers glad_wglSwapLayerBuffers
typedef BOOL (APIENTRYP PFNWGLUSEFONTBITMAPSPROC)(HDC hDC, DWORD first, DWORD count, DWORD listBase);
GLAPI PFNWGLUSEFONTBITMAPSPROC glad_wglUseFontBitmaps;
#define qwglUseFontBitmaps glad_wglUseFontBitmaps
typedef BOOL (APIENTRYP PFNWGLUSEFONTBITMAPSAPROC)(HDC hDC, DWORD first, DWORD count, DWORD listBase);
GLAPI PFNWGLUSEFONTBITMAPSAPROC glad_wglUseFontBitmapsA;
#define qwglUseFontBitmapsA glad_wglUseFontBitmapsA
typedef BOOL (APIENTRYP PFNWGLUSEFONTBITMAPSWPROC)(HDC hDC, DWORD first, DWORD count, DWORD listBase);
GLAPI PFNWGLUSEFONTBITMAPSWPROC glad_wglUseFontBitmapsW;
#define qwglUseFontBitmapsW glad_wglUseFontBitmapsW
...
GLAPI PFNWGLUSEFONTOUTLINESPROC glad_wglUseFontOutlines;
#define qwglUseFontOutlines glad_wglUseFontOutlines
...
GLAPI PFNWGLUSEFONTOUTLINESAPROC glad_wglUseFontOutlinesA;
#define qwglUseFontOutlinesA glad_wglUseFontOutlinesA
...
GLAPI PFNWGLUSEFONTOUTLINESWPROC glad_wglUseFontOutlinesW;
#define qwglUseFontOutlinesW glad_wglUseFontOutlinesW
#endif
...
#if defined(GLAD_COMPILE_LOADER) || WGL_3DFX_multisample
GLAPI int GLAD_WGL_3DFX_multisample;
#endif
#if defined(GLAD_COMPILE_LOADER) || WGL_3DL_stereo_control
...
#define qwglSetStereoEmitterState3DL glad_wglSetStereoEmitterState3DL
#endif
#if defined(GLAD_COMPILE_LOADER) || WGL_AMD_gpu_association
...
#define qwglGetGPUIDsAMD glad_wglGetGPUIDsAMD
...
#define qwglGetGPUInfoAMD glad_wglGetGPUInfoAMD
...
#define qwglGetContextGPUIDAMD glad_wglGetContextGPUIDAMD
...
#define qwglCreateAssociatedContextAMD glad_wglCreateAssociatedContextAMD
...
#define qwglCreateAssociatedContextAttribsAMD glad_wglCreateAssociatedContextAttribsAMD
...
#define qwglDeleteAssociatedContextAMD glad_wglDeleteAssociatedContextAMD
...
#define qwglMakeAssociatedContextCurrentAMD glad_wglMakeAssociatedContextCurrentAMD
...
#define qwglGetCurrentAssociatedContextAMD glad_wglGetCurrentAssociatedContextAMD
...
#define qwglBlitContextFramebufferAMD glad_wglBlitContextFramebufferAMD
#endif
#if defined(GLAD_COMPILE_LOADER) || WGL_ARB_buffer_region
...
#define qwglCreateBufferRegionARB glad_wglCreateBufferRegionARB
...
#define qwglDeleteBufferRegionARB glad_wglDeleteBufferRegionARB
...
#define qwglSaveBufferRegionARB glad_wglSaveBufferRegionARB
...
#define qwglRestoreBufferRegionARB glad_wglRestoreBufferRegionARB
#endif
#if defined(GLAD_COMPILE_LOADER) || WGL_ARB_context_flush_control
GLAPI int GLAD_WGL_ARB_context_flush_control;
#endif
#if defined(GLAD_COMPILE_LOADER) || WGL_ARB_create_context
...
#define qwglCreateContextAttribsARB glad_wglCreateContextAttribsARB
#endif
#if defined(GLAD_COMPILE_LOADER) || WGL_ARB_create_context_no_error
GLAPI int GLAD_WGL_ARB_create_context_no_error;
#endif
#if defined(GLAD_COMPILE_LOADER) || WGL_ARB_create_context_profile
GLAPI int GLAD_WGL_ARB_create_context_profile;
#endif
#if defined(GLAD_COMPILE_LOADER) || WGL_ARB_create_context_robustness
GLAPI int GLAD_WGL_ARB_create_context_robustness;
#endif
#if defined(GLAD_COMPILE_LOADER) || WGL_ARB_extensions_string
...
#define qwglGetExtensionsStringARB glad_wglGetExtensionsStringARB
#endif
#if defined(GLAD_COMPILE_LOADER) || WGL_ARB_framebuffer_sRGB
GLAPI int GLAD_WGL_ARB_framebuffer_sRGB;
#endif
#if defined(GLAD_COMPILE_LOADER) || WGL_ARB_make_current_read
...
#define qwglMakeContextCurrentARB glad_wglMakeContextCurrentARB
typedef HDC (APIENTRYP PFNWGLGETCURRENTREADDCARBPROC)(void);
GLAPI PFNWGLGETCURRENTREADDCARBPROC glad_wglGetCurrentReadDCARB;
#define qwglGetCurrentReadDCARB glad_wglGetCurrentReadDCARB
#endif
#if defined(GLAD_COMPILE_LOADER) || WGL_ARB_multisample
GLAPI int GLAD_WGL_ARB_multisample;
#endif
#if defined(GLAD_COMPILE_LOADER) || WGL_ARB_pbuffer
...
#define qwglCreatePbufferARB glad_wglCreatePbufferARB
...
#define qwglGetPbufferDCARB glad_wglGetPbufferDCARB
...
#define qwglReleasePbufferDCARB glad_wglReleasePbufferDCARB
...
#define qwglDestroyPbufferARB glad_wglDestroyPbufferARB
...
#define qwglQueryPbufferARB glad_wglQueryPbufferARB
#endif
#if defined(GLAD_COMPILE_LOADER) || WGL_ARB_pixel_format
...
#define qwglGetPixelFormatAttribivARB glad_wglGetPixelFormatAttribivARB
...
#define qwglGetPixelFormatAttribfvARB glad_wglGetPixelFormatAttribfvARB
...
#define qwglChoosePixelFormatARB glad_wglChoosePixelFormatARB
#endif
#if defined(GLAD_COMPILE_LOADER) || WGL_ARB_pixel_format_float
GLAPI int GLAD_WGL_ARB_pixel_format_float;
#endif
#if defined(GLAD_COMPILE_LOADER) || WGL_ARB_render_texture
...
#define qwglBindTexImageARB glad_wglBindTexImageARB
...
#define qwglReleaseTexImageARB glad_wglReleaseTexImageARB
...
#define qwglSetPbufferAttribARB glad_wglSetPbufferAttribARB
#endif
#if defined(GLAD_COMPILE_LOADER) || WGL_ARB_robustness_application_isolation
GLAPI int GLAD_WGL_ARB_robustness_application_isolation;
#endif
#if defined(GLAD_COMPILE_LOADER) || WGL_ARB_robustness_share_group_isolation
GLAPI int GLAD_WGL_ARB_robustness_share_group_isolation;
#endif
#if defined(GLAD_COMPILE_LOADER) || WGL_ATI_pixel_format_float
GLAPI int GLAD_WGL_ATI_pixel_format_float;
#endif
#if defined(GLAD_COMPILE_LOADER) || WGL_ATI_render_texture_rectangle
GLAPI int GLAD_WGL_ATI_render_texture_rectangle;
#endif
#if defined(GLAD_COMPILE_LOADER) || WGL_EXT_colorspace
GLAPI int GLAD_WGL_EXT_colorspace;
#endif
#if defined(GLAD_COMPILE_LOADER) || WGL_EXT_create_context_es2_profile
GLAPI int GLAD_WGL_EXT_create_context_es2_profile;
#endif
#if defined(GLAD_COMPILE_LOADER) || WGL_EXT_create_context_es_profile
GLAPI int GLAD_WGL_EXT_create_context_es_profile;
#endif
#if defined(GLAD_COMPILE_LOADER) || WGL_EXT_depth_float
GLAPI int GLAD_WGL_EXT_depth_float;
#endif
#if defined(GLAD_COMPILE_LOADER) || WGL_EXT_display_color_table
...
#define qwglCreateDisplayColorTableEXT glad_wglCreateDisplayColorTableEXT
...
#define qwglLoadDisplayColorTableEXT glad_wglLoadDisplayColorTableEXT
...
#define qwglBindDisplayColorTableEXT glad_wglBindDisplayColorTableEXT
...
#define qwglDestroyDisplayColorTableEXT glad_wglDestroyDisplayColorTableEXT
#endif
#if defined(GLAD_COMPILE_LOADER) || WGL_EXT_extensions_string
...
#define qwglGetExtensionsStringEXT glad_wglGetExtensionsStringEXT
#endif
#if defined(GLAD_COMPILE_LOADER) || WGL_EXT_framebuffer_sRGB
GLAPI int GLAD_WGL_EXT_framebuffer_sRGB;
#endif
#if defined(GLAD_COMPILE_LOADER) || WGL_EXT_make_current_read
...
#define qwglMakeContextCurrentEXT glad_wglMakeContextCurrentEXT
typedef HDC (APIENTRYP PFNWGLGETCURRENTREADDCEXTPROC)(void);
GLAPI PFNWGLGETCURRENTREADDCEXTPROC glad_wglGetCurrentReadDCEXT;
#define qwglGetCurrentReadDCEXT glad_wglGetCurrentReadDCEXT
#endif
#if defined(GLAD_COMPILE_LOADER) || WGL_EXT_multisample
GLAPI int GLAD_WGL_EXT_multisample;
#endif
#if defined(GLAD_COMPILE_LOADER) || WGL_EXT_pbuffer
...
#define qwglCreatePbufferEXT glad_wglCreatePbufferEXT
...
#define qwglGetPbufferDCEXT glad_wglGetPbufferDCEXT
...
#define qwglReleasePbufferDCEXT glad_wglReleasePbufferDCEXT
...
#define qwglDestroyPbufferEXT glad_wglDestroyPbufferEXT
...
#define qwglQueryPbufferEXT glad_wglQueryPbufferEXT
#endif
#if defined(GLAD_COMPILE_LOADER) || WGL_EXT_pixel_format
...
#define qwglGetPixelFormatAttribivEXT glad_wglGetPixelFormatAttribivEXT
...
#define qwglGetPixelFormatAttribfvEXT glad_wglGetPixelFormatAttribfvEXT
...
#define qwglChoosePixelFormatEXT glad_wglChoosePixelFormatEXT
#endif
#if defined(GLAD_COMPILE_LOADER) || WGL_EXT_pixel_format_packed_float
GLAPI int GLAD_WGL_EXT_pixel_format_packed_float;
#endif
#if defined(GLAD_COMPILE_LOADER) || WGL_EXT_swap_control
...
#define qwglSwapIntervalEXT glad_wglSwapIntervalEXT
typedef int (APIENTRYP PFNWGLGETSWAPINTERVALEXTPROC)(void);
GLAPI PFNWGLGETSWAPINTERVALEXTPROC glad_wglGetSwapIntervalEXT;
#define qwglGetSwapIntervalEXT glad_wglGetSwapIntervalEXT
#endif
#if defined(GLAD_COMPILE_LOADER) || WGL_EXT_swap_control_tear
GLAPI int GLAD_WGL_EXT_swap_control_tear;
#endif
#if defined(GLAD_COMPILE_LOADER) || WGL_I3D_digital_video_control
...
#define qwglGetDigitalVideoParametersI3D glad_wglGetDigitalVideoParametersI3D
...
#define qwglSetDigitalVideoParametersI3D glad_wglSetDigitalVideoParametersI3D
#endif
#if defined(GLAD_COMPILE_LOADER) || WGL_I3D_gamma
...
#define qwglGetGammaTableParametersI3D glad_wglGetGammaTableParametersI3D
...
#define qwglSetGammaTableParametersI3D glad_wglSetGammaTableParametersI3D
...
#define qwglGetGammaTableI3D glad_wglGetGammaTableI3D
...
#define qwglSetGammaTableI3D glad_wglSetGammaTableI3D
#endif
#if defined(GLAD_COMPILE_LOADER) || WGL_I3D_genlock
...
#define qwglIsEnabledGenlockI3D glad_wglIsEnabledGenlockI3D
...
#define qwglGenlockSourceI3D glad_wglGenlockSourceI3D
...
#define qwglGetGenlockSourceI3D glad_wglGetGenlockSourceI3D
...
#define qwglGenlockSourceEdgeI3D glad_wglGenlockSourceEdgeI3D
...
#define qwglGetGenlockSourceEdgeI3D glad_wglGetGenlockSourceEdgeI3D
...
#define qwglGenlockSampleRateI3D glad_wglGenlockSampleRateI3D
...
#define qwglGetGenlockSampleRateI3D glad_wglGetGenlockSampleRateI3D
...
#define qwglGenlockSourceDelayI3D glad_wglGenlockSourceDelayI3D
...
#define qwglGetGenlockSourceDelayI3D glad_wglGetGenlockSourceDelayI3D
...
#define qwglQueryGenlockMaxSourceDelayI3D glad_wglQueryGenlockMaxSourceDelayI3D
#endif
#if defined(GLAD_COMPILE_LOADER) || WGL_I3D_image_buffer
...
#define qwglCreateImageBufferI3D glad_wglCreateImageBufferI3D
...
#define qwglDestroyImageBufferI3D glad_wglDestroyImageBufferI3D
...
#define qwglAssociateImageBufferEventsI3D glad_wglAssociateImageBufferEventsI3D
...
#define qwglReleaseImageBufferEventsI3D glad_wglReleaseImageBufferEventsI3D
#endif
#if defined(GLAD_COMPILE_LOADER) || WGL_I3D_swap_frame_lock
...
#define qwglIsEnabledFrameLockI3D glad_wglIsEnabledFrameLockI3D
...
#define qwglQueryFrameLockMasterI3D glad_wglQueryFrameLockMasterI3D
#endif
#if defined(GLAD_COMPILE_LOADER) || WGL_I3D_swap_frame_usage
...
#define qwglGetFrameUsageI3D glad_wglGetFrameUsageI3D
...
#define qwglBeginFrameTrackingI3D glad_wglBeginFrameTrackingI3D
typedef BOOL (APIENTRYP PFNWGLENDFRAMETRACKINGI3DPROC)(void);
GLAPI PFNWGLENDFRAMETRACKINGI3DPROC glad_wglEndFrameTrackingI3D;
#define qwglEndFrameTrackingI3D glad_wglEndFrameTrackingI3D
...
#define qwglQueryFrameTrackingI3D glad_wglQueryFrameTrackingI3D
#endif
#if defined(GLAD_COMPILE_LOADER) || WGL_NV_DX_interop
...
#define qwglDXRegisterObjectNV glad_wglDXRegisterObjectNV
...
#define qwglDXUnregisterObjectNV glad_wglDXUnregisterObjectNV
...
#define qwglDXObjectAccessNV glad_wglDXObjectAccessNV
...
#define qwglDXLockObjectsNV glad_wglDXLockObjectsNV
...
#define qwglDXUnlockObjectsNV glad_wglDXUnlockObjectsNV
#endif
#if defined(GLAD_COMPILE_LOADER) || WGL_NV_DX_interop2
GLAPI int GLAD_WGL_NV_DX_interop2;
#endif
#if defined(GLAD_COMPILE_LOADER) || WGL_NV_copy_image
...
#define qwglCopyImageSubDataNV glad_wglCopyImageSubDataNV
#endif
#if defined(GLAD_COMPILE_LOADER) || WGL_NV_delay_before_swap
...
#define qwglDelayBeforeSwapNV glad_wglDelayBeforeSwapNV
#endif
#if defined(GLAD_COMPILE_LOADER) || WGL_NV_float_buffer
GLAPI int GLAD_WGL_NV_float_buffer;
#endif
#if defined(GLAD_COMPILE_LOADER) || WGL_NV_gpu_affinity
...
#define qwglEnumGpusNV glad_wglEnumGpusNV
...
#define qwglEnumGpuDevicesNV glad_wglEnumGpuDevicesNV
...
#define qwglCreateAffinityDCNV glad_wglCreateAffinityDCNV
...
#define qwglEnumGpusFromAffinityDCNV glad_wglEnumGpusFromAffinityDCNV
typedef BOOL (APIENTRYP PFNWGLDELETEDCNVPROC)(HDC hdc);
GLAPI PFNWGLDELETEDCNVPROC glad_wglDeleteDCNV;
#define qwglDeleteDCNV glad_wglDeleteDCNV
#endif
#if defined(GLAD_COMPILE_LOADER) || WGL_NV_multisample_coverage
GLAPI int GLAD_WGL_NV_multisample_coverage;
#endif
#if defined(GLAD_COMPILE_LOADER) || WGL_NV_present_video
...
#define qwglEnumerateVideoDevicesNV glad_wglEnumerateVideoDevicesNV
...
#define qwglBindVideoDeviceNV glad_wglBindVideoDeviceNV
...
#define qwglQueryCurrentContextNV glad_wglQueryCurrentContextNV
#endif
#if defined(GLAD_COMPILE_LOADER) || WGL_NV_render_depth_texture
GLAPI int GLAD_WGL_NV_render_depth_texture;
#endif
#if defined(GLAD_COMPILE_LOADER) || WGL_NV_render_texture_rectangle
GLAPI int GLAD_WGL_NV_render_texture_rectangle;
#endif
#if defined(GLAD_COMPILE_LOADER) || WGL_NV_swap_group
...
#define qwglJoinSwapGroupNV glad_wglJoinSwapGroupNV
...
#define qwglBindSwapBarrierNV glad_wglBindSwapBarrierNV
...
#define qwglQuerySwapGroupNV glad_wglQuerySwapGroupNV
...
#define qwglQueryMaxSwapGroupsNV glad_wglQueryMaxSwapGroupsNV
...
#define qwglQueryFrameCountNV glad_wglQueryFrameCountNV
typedef BOOL (APIENTRYP PFNWGLRESETFRAMECOUNTNVPROC)(HDC hDC);
GLAPI PFNWGLRESETFRAMECOUNTNVPROC glad_wglResetFrameCountNV;
#define qwglResetFrameCountNV glad_wglResetFrameCountNV
#endif
#if defined(GLAD_COMPILE_LOADER) || WGL_NV_vertex_array_range
...
#define qwglAllocateMemoryNV glad_wglAllocateMemoryNV
typedef void (APIENTRYP PFNWGLFREEMEMORYNVPROC)(void *pointer);
GLAPI PFNWGLFREEMEMORYNVPROC glad_wglFreeMemoryNV;
#define qwglFreeMemoryNV glad_wglFreeMemoryNV
#endif
#if defined(GLAD_COMPILE_LOADER) || WGL_NV_video_capture
...
#define qwglBindVideoCaptureDeviceNV glad_wglBindVideoCaptureDeviceNV
...
#define qwglEnumerateVideoCaptureDevicesNV glad_wglEnumerateVideoCaptureDevicesNV
...
#define qwglLockVideoCaptureDeviceNV glad_wglLockVideoCaptureDeviceNV
...
#define qwglQueryVideoCaptureDeviceNV glad_wglQueryVideoCaptureDeviceNV
...
#define qwglReleaseVideoCaptureDeviceNV glad_wglReleaseVideoCaptureDeviceNV
#endif
#if defined(GLAD_COMPILE_LOADER) || WGL_NV_video_output
...
#define qwglGetVideoDeviceNV glad_wglGetVideoDeviceNV
...
#define qwglReleaseVideoDeviceNV glad_wglReleaseVideoDeviceNV
...
#define qwglBindVideoImageNV glad_wglBindVideoImageNV
...
#define qwglReleaseVideoImageNV glad_wglReleaseVideoImageNV
...
#define qwglSendPbufferToVideoNV glad_wglSendPbufferToVideoNV
...
#define qwglGetVideoInfoNV glad_wglGetVideoInfoNV
#endif
#if defined(GLAD_COMPILE_LOADER) || WGL_OML_sync_control
...
#define qwglGetSyncValuesOML glad_wglGetSyncValuesOML
...
#define qwglGetMscRateOML glad_wglGetMscRateOML
...
#define qwglSwapBuffersMscOML glad_wglSwapBuffersMscOML
...
#define qwglSwapLayerBuffersMscOML glad_wglSwapLayerBuffersMscOML
...
#define qwglWaitForMscOML glad_wglWaitForMscOML
...
#define qwglWaitForSbcOML glad_wglWaitForSbcOML
#endif
