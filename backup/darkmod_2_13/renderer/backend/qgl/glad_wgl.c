...
PFNCHOOSEPIXELFORMATPROC glad_ChoosePixelFormat = NULL;
PFNDESCRIBEPIXELFORMATPROC glad_DescribePixelFormat = NULL;
PFNGETENHMETAFILEPIXELFORMATPROC glad_GetEnhMetaFilePixelFormat = NULL;
PFNGETPIXELFORMATPROC glad_GetPixelFormat = NULL;
PFNSETPIXELFORMATPROC glad_SetPixelFormat = NULL;
PFNSWAPBUFFERSPROC glad_SwapBuffers = NULL;
PFNWGLCOPYCONTEXTPROC glad_wglCopyContext = NULL;
PFNWGLCREATECONTEXTPROC glad_wglCreateContext = NULL;
PFNWGLCREATELAYERCONTEXTPROC glad_wglCreateLayerContext = NULL;
PFNWGLDELETECONTEXTPROC glad_wglDeleteContext = NULL;
PFNWGLDESCRIBELAYERPLANEPROC glad_wglDescribeLayerPlane = NULL;
PFNWGLGETCURRENTCONTEXTPROC glad_wglGetCurrentContext = NULL;
PFNWGLGETCURRENTDCPROC glad_wglGetCurrentDC = NULL;
PFNWGLGETLAYERPALETTEENTRIESPROC glad_wglGetLayerPaletteEntries = NULL;
PFNWGLGETPROCADDRESSPROC glad_wglGetProcAddress = NULL;
PFNWGLMAKECURRENTPROC glad_wglMakeCurrent = NULL;
PFNWGLREALIZELAYERPALETTEPROC glad_wglRealizeLayerPalette = NULL;
PFNWGLSETLAYERPALETTEENTRIESPROC glad_wglSetLayerPaletteEntries = NULL;
PFNWGLSHARELISTSPROC glad_wglShareLists = NULL;
PFNWGLSWAPLAYERBUFFERSPROC glad_wglSwapLayerBuffers = NULL;
PFNWGLUSEFONTBITMAPSPROC glad_wglUseFontBitmaps = NULL;
PFNWGLUSEFONTBITMAPSAPROC glad_wglUseFontBitmapsA = NULL;
PFNWGLUSEFONTBITMAPSWPROC glad_wglUseFontBitmapsW = NULL;
PFNWGLUSEFONTOUTLINESPROC glad_wglUseFontOutlines = NULL;
PFNWGLUSEFONTOUTLINESAPROC glad_wglUseFontOutlinesA = NULL;
PFNWGLUSEFONTOUTLINESWPROC glad_wglUseFontOutlinesW = NULL;
...
static void load_WGL_VERSION_1_0(GLADloadproc load) {
	if(!GLAD_WGL_VERSION_1_0) return;
	glad_ChoosePixelFormat = (PFNCHOOSEPIXELFORMATPROC)load("ChoosePixelFormat");
	glad_DescribePixelFormat = (PFNDESCRIBEPIXELFORMATPROC)load("DescribePixelFormat");
	glad_GetEnhMetaFilePixelFormat = (PFNGETENHMETAFILEPIXELFORMATPROC)load("GetEnhMetaFilePixelFormat");
	glad_GetPixelFormat = (PFNGETPIXELFORMATPROC)load("GetPixelFormat");
	glad_SetPixelFormat = (PFNSETPIXELFORMATPROC)load("SetPixelFormat");
	glad_SwapBuffers = (PFNSWAPBUFFERSPROC)load("SwapBuffers");
	glad_wglCopyContext = (PFNWGLCOPYCONTEXTPROC)load("wglCopyContext");
	glad_wglCreateContext = (PFNWGLCREATECONTEXTPROC)load("wglCreateContext");
	glad_wglCreateLayerContext = (PFNWGLCREATELAYERCONTEXTPROC)load("wglCreateLayerContext");
	glad_wglDeleteContext = (PFNWGLDELETECONTEXTPROC)load("wglDeleteContext");
	glad_wglDescribeLayerPlane = (PFNWGLDESCRIBELAYERPLANEPROC)load("wglDescribeLayerPlane");
	glad_wglGetCurrentContext = (PFNWGLGETCURRENTCONTEXTPROC)load("wglGetCurrentContext");
	glad_wglGetCurrentDC = (PFNWGLGETCURRENTDCPROC)load("wglGetCurrentDC");
	glad_wglGetLayerPaletteEntries = (PFNWGLGETLAYERPALETTEENTRIESPROC)load("wglGetLayerPaletteEntries");
	glad_wglGetProcAddress = (PFNWGLGETPROCADDRESSPROC)load("wglGetProcAddress");
	glad_wglMakeCurrent = (PFNWGLMAKECURRENTPROC)load("wglMakeCurrent");
	glad_wglRealizeLayerPalette = (PFNWGLREALIZELAYERPALETTEPROC)load("wglRealizeLayerPalette");
	glad_wglSetLayerPaletteEntries = (PFNWGLSETLAYERPALETTEENTRIESPROC)load("wglSetLayerPaletteEntries");
	glad_wglShareLists = (PFNWGLSHARELISTSPROC)load("wglShareLists");
	glad_wglSwapLayerBuffers = (PFNWGLSWAPLAYERBUFFERSPROC)load("wglSwapLayerBuffers");
	glad_wglUseFontBitmaps = (PFNWGLUSEFONTBITMAPSPROC)load("wglUseFontBitmaps");
	glad_wglUseFontBitmapsA = (PFNWGLUSEFONTBITMAPSAPROC)load("wglUseFontBitmapsA");
	glad_wglUseFontBitmapsW = (PFNWGLUSEFONTBITMAPSWPROC)load("wglUseFontBitmapsW");
	glad_wglUseFontOutlines = (PFNWGLUSEFONTOUTLINESPROC)load("wglUseFontOutlines");
	glad_wglUseFontOutlinesA = (PFNWGLUSEFONTOUTLINESAPROC)load("wglUseFontOutlinesA");
	glad_wglUseFontOutlinesW = (PFNWGLUSEFONTOUTLINESWPROC)load("wglUseFontOutlinesW");
}
...
int gladLoadWGLLoader(GLADloadproc load, HDC hdc) {
	...
	glad_wglGetExtensionsStringARB = (PFNWGLGETEXTENSIONSSTRINGARBPROC)load("wglGetExtensionsStringARB");
	glad_wglGetExtensionsStringEXT = (PFNWGLGETEXTENSIONSSTRINGEXTPROC)load("wglGetExtensionsStringEXT");
	if(glad_wglGetExtensionsStringARB == NULL && glad_wglGetExtensionsStringEXT == NULL) return 0;
	find_coreWGL(hdc);
	load_WGL_VERSION_1_0(load);
