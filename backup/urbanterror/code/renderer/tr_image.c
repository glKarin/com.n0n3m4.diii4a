...
void R_ImageList_f( void ) {
	...
	for ( i = 0 ; i < tr.numImages ; i++ ) {
		...
		case 4:
			...
			break;
#ifndef USE_OPENGLES //karin: not support DXT compression image on GLES 1.1
		case GL_RGBA8:
...
#ifndef USE_OPENGLES //karin: always use GL_RGBA for solid on GLES 1.1
