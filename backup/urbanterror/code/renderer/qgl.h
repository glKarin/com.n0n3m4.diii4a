...
#elif defined( __ANDROID__ ) //karin: GLES
#	include <EGL/egl.h>
#	include <GLES/gl.h>
...
//#define glClipDepth glClipDepthf
...
extern  void ( APIENTRY * qglMultiTexCoord4f )( GLenum texture, GLfloat s, GLfloat t, GLfloat r, GLfloat q );
...
#if !defined(__ANDROID__) //karin: EGL
