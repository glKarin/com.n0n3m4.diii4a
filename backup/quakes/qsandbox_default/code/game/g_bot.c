...
===============
*/
/*static */void G_AddBot( const char *name, float skill, const char *team, int delay, char *altname, int parentEntityNum, char* waypoint, int customspbot, gentity_t *spawn ) { //karin: make non-static
	int				clientNum;
	char			*botinfo;
	gentity_t		*bot;
	char			*key;
