...
#if !defined(_CG_MARK_EXTRAS) //karin: use std c library
#include "cg_local.h"
...
void CG_AddMarks( void ) {
	...
	/*trap_Cvar_VariableStringBuffer( "r_ambientSun", var, sizeof( var ) );
	if ( atof(var) < 0.12 ) {
		return;
	}*/
...
#ifdef _CG_MARK_EXTRAS //karin: use std c library
