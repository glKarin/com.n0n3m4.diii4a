...
//	r_stencilbits = ri.Cvar_Get( "r_stencilbits", "8", CVAR_ARCHIVE | CVAR_LATCH );
	...
	r_fx_greyscale = ri.Cvar_Get("r_fx_greyscale", "0", CVAR_ARCHIVE | CVAR_LATCH);
	ri.Cvar_CheckRange( r_fx_greyscale, "0", "1", CV_FLOAT );
	ri.Cvar_SetDescription( r_fx_greyscale, "Desaturates rendered frame." );
	...
	r_forceToneMap = ri.Cvar_Get( "r_forceToneMap", "0", CVAR_ARCHIVE );
	r_forceToneMapMin = ri.Cvar_Get( "r_forceToneMapMin", "-8.0", CVAR_ARCHIVE );
	r_forceToneMapAvg = ri.Cvar_Get( "r_forceToneMapAvg", "-2.0", CVAR_ARCHIVE );
	r_forceToneMapMax = ri.Cvar_Get( "r_forceToneMapMax", "0.0", CVAR_ARCHIVE );
	...
	r_deluxeSpecular = ri.Cvar_Get("r_deluxeSpecular", "0.30", CVAR_ARCHIVE | CVAR_LATCH);
	...
	r_ambientScale = ri.Cvar_Get( "r_ambientScale", "3.50", CVAR_CHEAT );
