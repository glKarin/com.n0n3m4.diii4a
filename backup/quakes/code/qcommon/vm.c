...
#ifdef __ANDROID__ //karin: library name on Android
	Com_sprintf( filename, sizeof( filename ), "qs%s" DLL_EXT, name );
#else
...
#ifdef __ANDROID__ //karin: force use native library
...
#ifdef __ANDROID__ //karin: TODO: crash
		static 
#endif
