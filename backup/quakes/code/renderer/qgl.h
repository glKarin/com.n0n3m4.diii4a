...
#include <windows.h>
#include <GL/gl.h>
#elif defined(__ANDROID__) //karin: OpenGL on Android
#include <EGL/egl.h>
#include <GLES/gl.h>
...
#define GL_DEPTH_COMPONENT GL_DEPTH_COMPONENT24_OES //                   0x1902
#endif
#ifndef GL_CLAMP
...
//===========================================================================
// #ifdef __ANDROID__ //karin: OpenGL ES procs
...
#define QGL_1_1_FIXED_FUNCTION_PROCS \
	...
	GLE(void, glColorPointer, GLint size, GLenum type, GLsizei stride, const GLvoid *ptr) \
	GLE(void, glDisableClientState, GLenum cap) \
	GLE(void, glEnableClientState, GLenum cap) \
	...
	GLE(void, glTexCoordPointer, GLint size, GLenum type, GLsizei stride, const GLvoid *ptr) \
	GLE(void, glTexEnvf, GLenum target, GLenum pname, GLfloat param) \
	GLE(void, glVertexPointer, GLint size, GLenum type, GLsizei stride, const GLvoid *ptr) \
	GLE(void, glFogf, GLenum pname, GLfloat param) /*Added*/ \
	GLE(void, glFogfv, GLenum pname, const GLfloat *params) /*Added*/ \
	GLE(void, glMultiTexCoord4f, GLenum target, GLfloat s, GLfloat t, GLfloat r, GLfloat q) /*Added*/ \
	GLE(void, glNormalPointer, GLenum type, GLsizei stride, const GLvoid *ptr) /*Added*/ \

// OpenGL ES 1.1 and OpenGL ES 2.0 but not desktop OpenGL 1.x
#define QGL_ES_1_1_PROCS \
	GLE(void, glClearDepthf, GLclampf depth) \
	GLE(void, glDepthRangef, GLclampf near_val, GLclampf far_val) \

// OpenGL ES 1.1 but not OpenGL ES 2.0 or desktop OpenGL 1.x
#define QGL_ES_1_1_FIXED_FUNCTION_PROCS \
	GLE(void, glClipPlanef, GLenum plane, const GLfloat *equation) \
	GLE(void, glFrustumf, GLfloat left, GLfloat right, GLfloat bottom, GLfloat top, GLfloat near_val, GLfloat far_val) \
	GLE(void, glOrthof, GLfloat left, GLfloat right, GLfloat bottom, GLfloat top, GLfloat near_val, GLfloat far_val) \
...
#elif defined(__ANDROID__) //karin: use EGL on Android
#else
#define QGL_Swp_PROCS \
...
#if !defined(__ANDROID__) //karin: use EGL on Android
