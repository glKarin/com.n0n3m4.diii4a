...
#ifdef __ANDROID__ //karin: OpenGL ES on Android
	QGL_1_1_PROCS;
...
#ifdef __ANDROID__ //karin: OpenGL ES on Android
static sym_t core_procs[] = { QGL_1_1_PROCS QGL_1_1_FIXED_FUNCTION_PROCS QGL_ES_1_1_PROCS QGL_ES_1_1_FIXED_FUNCTION_PROCS };
...
#if !defined(__ANDROID__) //karin: OpenGL ES on Android
