...
static void R_Register( void )
{
	...
	r_fx_greyscale = ri.Cvar_Get( "r_fx_greyscale", "0", CVAR_ARCHIVE_ND );
	ri.Cvar_CheckRange( r_fx_greyscale, "-1", "1", CV_FLOAT );
	ri.Cvar_SetDescription( r_fx_greyscale, "Desaturate rendered frame, requires \\r_fbo 1." );
