...
#if 0
#define _alloca( x )							(printf("_alloca(%d)\n", x),alloca( x ))
#define _alloca16( x )					(printf("_alloca16(%d)\n", x),((void *)((((uintptr_t)alloca( (x)+15 )) + 15) & ~15)))
#else
#define _alloca							alloca
...
//k #define ALIGNTYPE16						__attribute__((aligned(16)))
...
public:
	...
	virtual void			ShowGameWindow(bool show) = 0;
};
