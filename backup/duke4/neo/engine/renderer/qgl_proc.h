...
QGLPROC(glReadBuffer, void, (GLenum type))
QGLPROC(glUniformBlockBinding, void, (GLuint program, GLuint uniformBlockIndex, GLuint uniformBlockBinding))
QGLPROC(glGetUniformBlockIndex, GLuint, (GLuint program, const GLchar *uniformBlockName))
QGLPROC(glBindBufferRange, void, (GLenum target, GLuint index, GLuint buffer, GLintptr offset, GLsizeiptr size))
...
QGLPROC(glGetFragDataLocation, GLint, (GLuint program, const GLchar *name))
//QGLPROC(, void, ())
