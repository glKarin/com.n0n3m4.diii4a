...
*/
	cdkeyMenuInfo.accept.generic.type			= MTYPE_PTEXT;
	cdkeyMenuInfo.accept.generic.flags			= QMF_RIGHT_JUSTIFY|QMF_PULSEIFFOCUS;
	cdkeyMenuInfo.accept.generic.x				= 640 - 20;
	cdkeyMenuInfo.accept.generic.y				= 480 - 50;
	cdkeyMenuInfo.accept.generic.id				= ID_ACCEPT;
	cdkeyMenuInfo.accept.generic.callback		= UI_CDKeyMenu_Event; 
	cdkeyMenuInfo.accept.string					= "ACCEPT";
	cdkeyMenuInfo.accept.color					= text_color_normal;
	cdkeyMenuInfo.accept.style					= UI_RIGHT | UI_SMALLFONT;

	cdkeyMenuInfo.back.generic.type				= MTYPE_PTEXT;
	cdkeyMenuInfo.back.generic.flags			= QMF_LEFT_JUSTIFY|QMF_PULSEIFFOCUS;
