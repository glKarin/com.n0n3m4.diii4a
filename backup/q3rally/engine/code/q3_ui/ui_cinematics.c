...
#define ID_BACK			10
//TBB - replace all idlogo with q3rlogo
//#define ID_CIN_IDLOGO	11
#define ID_CIN_Q3RLOGO	11
...
static void UI_CinematicsMenu_Event( void *ptr, int event ) {
	...
	n = ((menucommon_s*)ptr)->id - ID_CIN_Q3RLOGO;
...
static void UI_CinematicsMenu_Init( void ) {
	...
	y = 100;
	cinematicsMenuInfo.cin_q3rlogo.generic.type		= MTYPE_PTEXT;
	cinematicsMenuInfo.cin_q3rlogo.generic.flags		= QMF_CENTER_JUSTIFY|QMF_PULSEIFFOCUS;
	cinematicsMenuInfo.cin_q3rlogo.generic.x			= 320;
	cinematicsMenuInfo.cin_q3rlogo.generic.y			= y;
	cinematicsMenuInfo.cin_q3rlogo.generic.id		= ID_CIN_Q3RLOGO;
	cinematicsMenuInfo.cin_q3rlogo.generic.callback	= UI_CinematicsMenu_Event; 
	cinematicsMenuInfo.cin_q3rlogo.string			= "Q3R LOGO";
	cinematicsMenuInfo.cin_q3rlogo.color				= color_red;
	cinematicsMenuInfo.cin_q3rlogo.style				= UI_CENTER;
	...
	Menu_AddItem( &cinematicsMenuInfo.menu, &cinematicsMenuInfo.cin_q3rlogo );
