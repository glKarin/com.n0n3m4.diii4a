...
const purePak_t com_purePaks[] =
{
	...
	{"baseq3", "pak1", 298122907u},
	{"baseq3", "pak2", 412165236u},
	{"baseq3", "pak3", 2991495316u},
	{"baseq3", "pak4", 1197932710u},
	{"baseq3", "pak5", 4087071573u},
	{"baseq3", "pak6", 3709064859u},
	{"baseq3", "pak7", 908855077u},
	{"baseq3", "pak8", 977125798u},

	#define	DEMO_PAK0_CHECKSUM	2985612116u
	{"demoq3", "pak0", DEMO_PAK0_CHECKSUM},

	{"missionpack", "pak0", 2430342401u},
	{"missionpack", "pak1", 511014160u},
	{"missionpack", "pak2", 2662638993u},
	{"missionpack", "pak3", 1438664554u},
#endif
...
int FS_FindVM(void **startSearch, char *found, int foundlen, const char *name, int enableDll)
{
	...
	if(enableDll)
	{
		Com_sprintf(dllName, sizeof(dllName), "%s%s" DLL_EXT, "q3rally", name);
		char path[MAX_OSPATH];
...
static void FS_CheckPaks( void )
{
	...
	for (pak = 0; com_purePaks[pak].pakname != NULL; pak++) {
		...
		if (!!Q_stricmpn( BASEGAME, com_purePaks[pak].gamename, MAX_OSPATH )
