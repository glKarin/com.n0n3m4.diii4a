...
*/
#define PROP_GAP_WIDTH			-3
#define PROP_SPACE_WIDTH		19
#define PROP_HEIGHT				32
#define PROP_SMALL_SIZE_SCALE	0.5
#define PROP_NORMAL_SIZE_SCALE	0.75
// END
...
// STONELANCE
#define	FLOAT2SHORT(x)	((int)((x)*16384))
...
typedef struct playerState_s {
	...
	// STONELANCE - FIXME: use this for something else?
	// STONELANCE - 8 bits over the net
#define bobCycle extra_eFlags // ZTM: Remove this later
//	int			bobCycle;		// for view bobbing and footstep generation
	...
	// STONELANCE - FIXME: use these for something else?
	// STONELANCE - both 16 bits over the net
	int			gravity;
	int			speed;
	...
	// STONELANCE - these are used as spring lengths - all 8 bits over the net (I think)
	...
	// STONELANCE - using this for brake and reverse
	// STONELANCE - 4 bits over the net
	int			observerMode;
#define movementDir observerMode // ZTM: Remove this later
//	int			movementDir;	// a number 0 to 7 that represents the relative angle
								// of movement to the view angle (axial and diagonals)
								// when at rest, the value will remain unchanged
								// used to twist the legs during strafing

	// STONELANCE grapplePoint now used as angular momentum
	vec3_t		angularMomentum;
#define grapplePoint angularMomentum // ZTM: Remove this later
...
// END
	...
	// STONELANCE FIXME - viewangles now used as car angles
	vec3_t		viewangles;		// for fixed views

	// STONELANCE - 32 bits over the net
	int			viewheight;
// END
	...
	// STONELANCE - 8 bits over the net
	// STONELANCE - damageYaw and Pitch used for view angles
	int			damageYaw;
	int			damagePitch;
...
// STONELANCE
#define	BUTTON_HORN			8
#define	BUTTON_TURBO		16
/*
...
// STONELANCE
#define	BUTTON_REARATTACK	0x1000
// use it for something else #define	BUTTON_DROPWEAPON	0x2000
#define	BUTTON_HANDBRAKE	0x4000			// cant go higher than this, maybe use button_any?
// END
...
// STONELANCE - 32 bits over the net
	...
	// STONELANCE - 24 bits over the net
...
// STONELANCE - possible way to optimize entityState
/*
