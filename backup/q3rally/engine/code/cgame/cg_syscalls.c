...
// Q3Rally Code Start
/*
  point:			point where to get light values (xyz)
  ambientLight:		color of ambientLight (rgb from 0 - 255)
  directedLight:	color of directedLight (rgb from 0 - 255)
  lightDir:			normalized direction of incoming light (xyz)
					based on directedLight
*/
// END
